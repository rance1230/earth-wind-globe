...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Fo(e,t,n){let r=new Float32Array(xo),i=new J(0,1,0);return new Wi({name:`SphericalGaussianBlur`,defines:{n:xo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ro(),fragmentShader:`
	...
	`}var zo=class extends Wt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Oi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};iu.BlurDirectionX=new q(1,0),iu.BlurDirectionY=new q(0,1);var au={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		}`},ou=class extends Jl{constructor(){super(),this.isOutputPass=!0,this.uniforms=Vi.clone(au.uniforms),this.material=new Gi({name:au.name,uniforms:this.uniforms,vertexShader:au.vertexShader,fragmentShader:au.fragmentShader}),this._fsQuad=new Zl(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},X.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},su={high:{windSegments:1e3,windPoints:14,satelliteCount:600,pixelRatioCap:2},low:{windSegments:500,windPoints:10,satelliteCount:300,pixelRatioCap:1.5}},cu={radius:2,cameraDistance:5.8,seed:1337,defaultQuality:`high`,windSegments:su.high.windSegments,windPoints:su.high.windPoints,satelliteCount:su.high.satelliteCount,pixelRatioCap:su.high.pixelRatioCap},lu={high:{albedoKtx2:`assets/earth/ktx2/blue-marble-8192x4096.ktx2`,albedo:`assets/earth/blue-marble-8192x4096.jpg`,albedoFallback:`assets/earth/blue-marble-5400x2700.jpg`,heightmap:`assets/earth/etopo1-heightmap-2880x1440.png`,heightmapFallback:`assets/earth/etopo1-heightmap-720x360.png`,normalKtx2:`assets/earth/ktx2/etopo1-normalmap-2880x1440.ktx2`,normalmap:`assets/earth/etopo1-normalmap-2880x1440.png`,normalmapFallback:`assets/earth/etopo1-normalmap-720x360.png`,albedoRes:[8192,4096],heightRes:[2880,1440],normalRes:[2880,1440],segmentsW:384,segmentsH:288},low:{albedoKtx2:null,albedo:`assets/earth/blue-marble-5400x2700.jpg`,albedoFallback:`assets/earth/blue-marble-5400x2700.jpg`,heightmap:`assets/earth/etopo1-heightmap-720x360.png`,heightmapFallback:`assets/earth/etopo1-heightmap-720x360.png`,normalKtx2:null,normalmap:`assets/earth/etopo1-normalmap-720x360.png`,normalmapFallback:`assets/earth/etopo1-normalmap-720x360.png`,albedoRes:[5400,2700],heightRes:[720,360],normalRes:[720,360],segmentsW:256,segmentsH:192}},uu=`assets/earth/night-lights-2048x1024.jpg`,du=.1,fu=`proceduralFallback`,pu=!1,mu=!1,hu=`cinematicPBR`,gu=!1,_u=!1,vu=`none`,yu=`high`,bu=[0,0],xu=[0,0],Su=[0,0],Cu={albedo:`none`,normal:`none`,height:`none`},wu=[];function Tu(){return fu}function Eu(){return pu}function Du(){return mu}function Ou(){return mu?`etopo1`:`none`}function ku(){return hu}function Au(){return gu}function ju(){return _u}function Mu(){return vu}function Nu(){return yu}function Pu(){return bu.slice()}function Fu(){return xu.slice()}function Iu(){return Su.slice()}function Lu(){return{...Cu}}function Ru(){return fu===`nasaBlueMarble`?`NASA Blue Marble — NASA Earth Observatory`:`Procedural fallback (not a high-precision map)`}function zu(e){pu?e():wu.push(e)}function Bu(e){fu=e,pu=!0,wu.forEach(e=>e()),wu=[]}function Vu(e){let t=e.width||720,r=e.height||360,i=document.createElement(`canvas`);i.width=t,i.height=r;let a=i.getContext(`2d`,{willReadFrequently:!0});a.drawImage(e,0,0,t,r);let o=a.getImageData(0,0,t,r).data,s=document.createElement(`canvas`);s.width=t,s.height=r;let c=s.getContext(`2d`),l=c.createImageData(t,r),u=l.data,d=document.createElement(`canvas`);d.width=t,d.height=r;let f=d.getContext(`2d`),p=f.createImageData(t,r),m=p.data;for(let e=0;e<o.length;e+=4){let t=o[e]/255,n=Hu(0,.045,t),r=220+Math.min(25,t*40),i=Math.round(92+(r-92)*n),a=Math.round((1-n)*140);u[e]=i,u[e+1]=i,u[e+2]=i,u[e+3]=255,m[e]=a,m[e+1]=a,m[e+2]=a,m[e+3]=255}c.putImageData(l,0,0),f.putImageData(p,0,0);let h=new ki(s);h.wrapS=n,h.colorSpace=``,h.needsUpdate=!0;let g=new ki(d);return g.wrapS=n,g.colorSpace=``,g.needsUpdate=!0,{roughnessMap:h,clearcoatMap:g}}function Hu(e,t,n){let r=Math.min(1,Math.max(0,(n-e)/(t-e)));return r*r*(3-2*r)}function Uu(e,t){let n=e?.image;return[n?.width||e?.source?.data?.width||t[0]||0,n?.height||e?.source?.data?.height||t[1]||0]}function Wu(e,t={}){let r=t.quality===`low`?`low`:`high`,i=lu[r],a=t.loaders||null;yu=r,bu=[0,0],xu=[0,0],Su=[0,0],Cu={albedo:`none`,normal:`none`,height:`none`};let o=new ki(Ku());o.colorSpace=Fe,o.wrapS=n,o.anisotropy=4;let s=new qi({map:o,emissive:new Z(16773328),emissiveMap:null,emissiveIntensity:0,roughness:.9,metalness:0,envMapIntensity:.32,clearcoat:.38,clearcoatRoughness:.42,reflectivity:.22,ior:1.33,transparent:!1,opacity:1,depthTest:!0,depthWrite:!0,side:0,displacementScale:0,displacementBias:0});hu=`cinematicPBR`,gu=!1,_u=!1,vu=`none`,s.onBeforeCompile=e=>{e.uniforms.uSunDir={value:new J(1,.2,0)},e.uniforms.uNightBoost={value:1.55},s.userData.shader=e,e.vertexShader=`
    ...
    `.replace(`#include <emissivemap_fragment>`,`
      ...
      `)},s.customProgramCacheKey=()=>`earth-cinematicPBR-nightLights-v4`;let c=new qr(new Fi(e,i.segmentsW,i.segmentsH),s),l=new ya,d=a?.loadTexture?.bind(a)||((e,t,n)=>{l.load(e.fallback,e=>t(e,`jpeg`),void 0,n)});function f(e,t,n,r){l.load(e,n,void 0,()=>{t&&t!==e?l.load(t,n,void 0,r):r?.()})}d({ktx2:r===`high`?i.albedoKtx2:null,fallback:i.albedo,colorSpace:Fe,anisotropy:r===`high`?16:8,wrapS:n},(e,t)=>{s.map=e,s.needsUpdate=!0,o.dispose(),bu=Uu(e,i.albedoRes),Cu.albedo=t,bu[0]>=3600?Bu(`nasaBlueMarble`):Bu(`proceduralFallback`),console.log(`[createEarth] albedo ${bu.join(`x`)} via ${t} (q=${r})`)},e=>{l.load(i.albedoFallback,e=>{e.colorSpace=Fe,e.wrapS=n,e.anisotropy=8,s.map=e,s.needsUpdate=!0,o.dispose(),bu=Uu(e,[5400,2700]),Cu.albedo=`jpeg`,Bu(`nasaBlueMarble`)},void 0,()=>{console.warn(`[createEarth] NASA texture load failed, using proceduralFallback:`,e),bu=[0,0],Cu.albedo=`none`,Bu(`proceduralFallback`)})});let p=(e,t)=>{e.wrapS=n,e.anisotropy=4,e.minFilter=u,s.displacementMap=e,s.displacementScale=du,s.displacementBias=0,s.needsUpdate=!0,mu=!0,Su=Uu(e,t),Cu.height=`png`;try{let t=e.image;if(t&&(t.width||t.naturalWidth)){let{roughnessMap:e,clearcoatMap:n}=Vu(t);s.roughnessMap=e,s.clearcoatMap=n,s.roughness=1,s.clearcoat=.42,s.clearcoatRoughness=.38,s.envMapIntensity=.38,s.needsUpdate=!0,gu=!0,hu=`cinematicPBR`}}catch(e){console.warn(`[createEarth] ocean/land PBR map generation failed:`,e),gu=!1}};f(i.heightmap,i.heightmapFallback,e=>p(e,i.heightRes),e=>{console.warn(`[createEarth] ETOPO1 heightmap load failed, smooth globe:`,e),mu=!1,gu=!1,Su=[0,0],Cu.height=`none`}),d({ktx2:r===`high`?i.normalKtx2:null,fallback:i.normalmap,colorSpace:``,anisotropy:r===`high`?8:4,wrapS:n},(e,t)=>{s.normalMap=e,s.normalScale=new q(r===`high`?1.55:1.35,r===`high`?1.55:1.35),s.needsUpdate=!0,xu=Uu(e,i.normalRes),Cu.normal=t},()=>{f(i.normalmapFallback,i.normalmapFallback,e=>{s.normalMap=e,s.normalScale=new q(1.35,1.35),s.needsUpdate=!0,xu=Uu(e,[720,360]),Cu.normal=`png`},()=>{xu=[0,0],Cu.normal=`none`})});let m=(e,t)=>{e.colorSpace=Fe,e.wrapS=n,e.anisotropy=8,e.minFilter=u,s.emissiveMap=e,s.emissiveIntensity=t===`nasaBlackMarble`?1.7:1.35,s.needsUpdate=!0,_u=!0,vu=t,console.log(`[createEarth] night lights enabled (${t})`)};return l.load(uu,e=>m(e,`nasaBlackMarble`),void 0,()=>{try{m(Gu(),`proceduralCities`)}catch(e){_u=!1,vu=`none`,s.emissiveIntensity=0,console.warn(`[createEarth] night lights unavailable:`,e)}}),c}function Gu(){let e=2048,t=1024,r=document.createElement(`canvas`);r.width=e,r.height=t;let i=r.getContext(`2d`);i.fillStyle=`#000000`,i.fillRect(0,0,e,t);for(let[n,r,a]of[[139.7,35.7,1],[-74,40.7,1],[-118.2,34,.9],[116.4,39.9,.95],[121.5,31.2,.95],[72.9,19.1,.9],[77.2,28.6,.85],[88.4,22.6,.7],[2.35,48.86,.85],[-.12,51.5,.85],[13.4,52.5,.7],[37.6,55.75,.8],[126.98,37.57,.85],[135.5,34.7,.75],[-46.6,-23.55,.85],[-43.2,-22.9,.7],[31.25,30.05,.75],[3.39,6.45,.65],[106.8,-6.17,.75],[100.5,13.75,.65],[103.85,1.29,.7],[151.2,-33.87,.7],[144.97,-37.81,.55],[-79.4,43.66,.6],[-87.63,41.85,.7],[-95.35,29.75,.55],[28.97,41.02,.7],[51.42,35.67,.55],[12.5,41.9,.55],[-3.7,40.4,.55],[4.9,52.37,.5],[139.75,35.68,1],[114.17,22.32,.75],[121.57,25.04,.6],[104.07,30.67,.55],[113.26,23.13,.7],[-99.13,19.43,.85],[-58.38,-34.6,.7],[18.42,-33.92,.45],[28.05,-26.2,.5],[36.82,-1.29,.45],[55.27,25.2,.55],[46.72,24.69,.5],[-77.04,38.9,.55]]){let o=(n+180)/360*e,s=(90-r)/180*t,c=6+a*18,l=i.createRadialGradient(o,s,0,o,s,c);l.addColorStop(0,`rgba(255, 230, 170, ${.55+a*.4})`),l.addColorStop(.35,`rgba(255, 180, 90, ${.25+a*.25})`),l.addColorStop(1,`rgba(0,0,0,0)`),i.fillStyle=l,i.beginPath(),i.arc(o,s,c,0,Math.PI*2),i.fill(),o<c?(i.beginPath(),i.arc(o+e,s,c,0,Math.PI*2),i.fill()):o>e-c&&(i.beginPath(),i.arc(o-e,s,c,0,Math.PI*2),i.fill())}let a=new ki(r);return a.colorSpace=Fe,a.wrapS=n,a.needsUpdate=!0,a}function Ku(){let e=2048,t=1024,n=document.createElement(`canvas`);n.width=e,n.height=t;let r=n.getContext(`2d`),i=r.createLinearGradient(0,0,0,t);i.addColorStop(0,`#08263f`),i.addColorStop(.18,`#0c3a63`),i.addColorStop(.5,`#0e4377`),i.addColorStop(.82,`#0c3a63`),i.addColorStop(1,`#08263f`),r.fillStyle=i,r.fillRect(0,0,e,t),r.globalAlpha=.06,r.strokeStyle=`#2db0ff`,r.lineWidth=2;for(let n=0;n<14;n+=1){let i=t*(.2+n/14*.6)|0;r.beginPath();for(let t=0;t<=e;t+=24)r.lineTo(t,i+Math.sin(t*.01+n)*6);r.stroke()}r.globalAlpha=1;let a=t=>(t+180)/360*e,o=e=>(90-e)/180*t;function s(e,t){r.beginPath(),e.forEach(([e,t],n)=>{let i=a(e),s=o(t);n===0?r.moveTo(i,s):r.lineTo(i,s)}),r.closePath(),r.fillStyle=t,r.fill()}let c=`#3a5a26`,l=`#dfeaf2`;return s([[-168,65],[-155,70],[-130,70],[-95,72],[-75,78],[-60,75],[-55,60],[-70,48],[-80,42],[-82,30],[-95,28],[-100,25],[-110,23],[-118,32],[-125,40],[-128,49],[-135,56],[-150,60],[-168,65]],c),s([[-95,22],[-86,18],[-78,9],[-83,8],[-92,16],[-95,22]],c),s([[-80,12],[-70,12],[-58,8],[-50,0],[-35,-8],[-38,-23],[-50,-34],[-65,-42],[-70,-53],[-74,-50],[-72,-38],[-76,-25],[-80,-12],[-82,0],[-80,12]],c),s([[-10,58],[5,60],[15,62],[30,60],[40,55],[38,47],[25,46],[12,45],[0,43],[-9,44],[-10,58]],c),s([[-17,21],[-5,35],[10,36],[25,32],[34,30],[38,18],[44,12],[51,11],[42,-2],[40,-15],[35,-25],[25,-34],[18,-34],[12,-20],[9,-5],[4,5],[-8,8],[-17,14],[-17,21]],`#6a5a2a`),r.globalAlpha=.5,s([[-10,28],[10,30],[25,30],[33,28],[30,20],[10,18],[-8,20],[-10,28]],`#9a6a2a`),r.globalAlpha=1,s([[30,60],[60,70],[90,74],[120,73],[150,70],[170,66],[175,60],[160,55],[140,50],[135,42],[125,38],[122,30],[110,22],[100,14],[92,12],[80,9],[72,22],[62,25],[55,26],[48,30],[45,38],[42,44],[40,50],[35,56],[30,60]],c),s([[70,24],[78,22],[88,22],[84,10],[78,8],[72,16],[70,24]],c),s([[95,5],[105,2],[115,0],[110,-4],[100,-2],[95,5]],c),s([[120,-2],[135,-3],[140,-5],[130,-8],[118,-7],[120,-2]],c),s([[114,-22],[125,-14],[138,-12],[145,-16],[153,-26],[150,-36],[140,-38],[128,-34],[118,-32],[114,-28],[114,-22]],`#7a6a30`),s([[-50,82],[-25,82],[-18,76],[-25,65],[-45,62],[-52,70],[-50,82]],`#9fb0bb`),r.globalAlpha=.92,r.fillStyle=l,r.fillRect(0,952,e,71),r.globalAlpha=1,r.globalAlpha=.85,r.fillStyle=l,r.fillRect(0,0,e,61),r.globalAlpha=1,n}var qu=`scatteringV1`;function Ju(){return qu}function Yu(e){let t=new Sn;qu=`scatteringV1`;let n=new Wi({transparent:!0,blending:2,depthWrite:!1,side:1,uniforms:{uSunDir:{value:new J(1,.2,0)},uRayleigh:{value:new Z(`#4aa7ff`)},uMie:{value:new Z(`#fff2e0`)},uHorizon:{value:new Z(`#ffb07a`)},uIntensity:{value:1.05},uPower:{value:3.2}},vertexShader:`
      varying vec3 vView;
    ...
    `}),r=new qr(new Fi(e*1.12,96,64),n);r.renderOrder=4,r.name=`atmosphere-rayleigh`,t.add(r);let i=new Wi({transparent:!0,blending:2,depthWrite:!1,side:1,uniforms:{uSunDir:{value:new J(1,.2,0)},uColor:{value:new Z(`#8fd9ff`)},uWarm:{value:new Z(`#ffc9a0`)},uIntensity:{value:.55},uPower:{value:5.5}},vertexShader:`
      varying vec3 vView;
      varying vec3 vWorldNormal;
      void main() {
        vWorldNormal = normalize(mat3(modelMatrix) * normal);
    ...
    `}),a=new qr(new Fi(e*1.055,96,64),i);a.renderOrder=5,a.name=`atmosphere-glow`,t.add(a);let o=new Wi({transparent:!0,blending:2,depthWrite:!1,depthTest:!0,side:0,uniforms:{uSunDir:{value:new J(1,.2,0)},uColor:{value:new Z(`#6eb8ff`)},uIntensity:{value:.12}},vertexShader:`
      varying vec3 vWorldNormal;
      varying vec3 vView;
      void main() {
        vWorldNormal = normalize(mat3(modelMatrix) * normal);
...
`);this.workerSourceURL=URL.createObjectURL(new Blob([i])),this.transcoderBinary=n,this.workerPool.setWorkerCreator(()=>{let e=new Worker(this.workerSourceURL),t=this.transcoderBinary.slice(0);return e.postMessage({type:`init`,config:this.workerConfig,transcoderBinary:t},[t]),e})}),gd>0&&console.warn(`THREE.KTX2Loader: Multiple active KTX2 loaders may cause performance issues. Use a single KTX2Loader instance, or call .dispose() on old instances.`),gd++}return this.transcoderPending}load(e,t,n,r){if(this.workerConfig===null)throw Error("THREE.KTX2Loader: Missing initialization with `.detectSupport( renderer )`.");let i=new ga(this.manager);i.setPath(this.path),i.setCrossOrigin(this.crossOrigin),i.setWithCredentials(this.withCredentials),i.setRequestHeader(this.requestHeader),i.setResponseType(`arraybuffer`),i.load(e,e=>{this.parse(e,t,r)},n,r)}parse(e,t,n){if(this.workerConfig===null)throw Error("THREE.KTX2Loader: Missing initialization with `.detectSupport( renderer )`.");if(hd.has(e))return hd.get(e).promise.then(t).catch(n);this._createTexture(e).then(e=>t?t(e):null).catch(n)}_createTextureFrom(e,t){let{type:n,error:r,data:{faces:i,width:a,height:o,format:s,type:l,dfdFlags:d}}=e;if(n===`error`)return Promise.reject(r);let f;if(t.faceCount===6)f=new Di(i,s,l);else{let e=i[0].mipmaps;f=t.layerCount>1?new Ei(e,a,o,t.layerCount,s,l):new Ti(e,a,o,s,l)}return f.minFilter=i[0].mipmaps.length===1?c:u,f.magFilter=c,f.generateMipmaps=!1,f.needsUpdate=!0,f.colorSpace=Cd(t),f.premultiplyAlpha=!!(d&1),f}async _createTexture(e,t={}){let n=od(new Uint8Array(e)),r=n.vkFormat===1000066e3&&n.dataFormatDescriptor[0].colorModel===167;if(!(n.vkFormat===0||r&&!this.workerConfig.astcHDRSupported))return Sd(n);let i=t,a=this.init().then(()=>this.workerPool.postMessage({type:`transcode`,buffer:e,taskConfig:i},[e])).then(e=>this._createTextureFrom(e.data,n));return hd.set(e,{promise:a}),a}dispose(){this.workerPool.dispose(),this.workerSourceURL&&URL.revokeObjectURL(this.workerSourceURL),gd--}};vd.BasisFormat={ETC1S:0,UASTC:1,UASTC_HDR:2},vd.TranscoderFormat={ETC1:0,ETC2:1,BC1:2,BC3:3,BC4:4,BC5:5,BC7_M6_OPAQUE_ONLY:6,BC7_M5:7,PVRTC1_4_RGB:8,PVRTC1_4_RGBA:9,ASTC_4x4:10,ATC_RGB:11,ATC_RGBA_INTERPOLATED_ALPHA:12,RGBA32:13,RGB565:14,BGR565:15,RGBA4444:16,BC6H:22,RGB_HALF:24,RGBA_HALF:25},vd.EngineFormat={RGBAFormat:E,RGBA_ASTC_4x4_Format:de,RGB_BPTC_UNSIGNED_Format:De,RGBA_BPTC_Format:Te,RGBA_ETC2_EAC_Format:L,RGBA_PVRTC_4BPPV1_Format:ie,RGBA_S3TC_DXT5_Format:te,RGB_ETC1_Format:ae,RGB_ETC2_Format:oe,RGB_PVRTC_4BPPV1_Format:ne,RGBA_S3TC_DXT1_Format:P},vd.EngineType={UnsignedByteType:d,HalfFloatType:v,FloatType:_},vd.BasisWorker=function(){let e,t,n,r=_EngineFormat,i=_EngineType,a=_TranscoderFormat,o=_BasisFormat;self.addEventListener(`message`,function(n){let r=n.data;switch(r.type){case`init`:e=r.config,s(r.transcoderBinary);break;case`transcode`:t.then(()=>{try{let{faces:e,buffers:t,width:n,height:i,hasAlpha:a,format:o,type:s,dfdFlags:l}=c(r.buffer);self.postMessage({type:`transcode`,id:r.id,data:{faces:e,width:n,height:i,hasAlpha:a,format:o,type:s,dfdFlags:l}},t)}catch(e){console.error(e),self.postMessage({type:`error`,id:r.id,error:e.message})}});break}});function s(e){t=new Promise(t=>{n={wasmBinary:e,onRuntimeInitialized:t},BASIS(n)}).then(()=>{n.initializeBasis(),n.KTX2File===void 0&&console.warn(`THREE.KTX2Loader: Please update Basis Universal transcoder.`)})}function c(e){let t=new n.KTX2File(new Uint8Array(e));function r(){t.close(),t.delete()}if(!t.isValid())throw r(),Error(`THREE.KTX2Loader:	Invalid or unsupported .ktx2 file`);let a;if(t.isUASTC())a=o.UASTC;else if(t.isETC1S())a=o.ETC1S;else if(t.isHDR())a=o.UASTC_HDR;else throw Error(`THREE.KTX2Loader: Unknown Basis encoding`);let s=t.getWidth(),c=t.getHeight(),l=t.getLayers()||1,u=t.getLevels(),f=t.getFaces(),m=t.getHasAlpha(),h=t.getDFDFlags(),{transcoderFormat:g,engineFormat:_,engineType:v}=d(a,s,c,m);if(!s||!c||!u)throw r(),Error(`THREE.KTX2Loader:	Invalid texture`);if(!t.startTranscoding())throw r(),Error(`THREE.KTX2Loader: .startTranscoding failed`);let y=[],b=[];for(let e=0;e<f;e++){let n=[];for(let a=0;a<u;a++){let o=[],s,c;for(let n=0;n<l;n++){let l=t.getImageLevelInfo(a,n,e);e===0&&a===0&&n===0&&(l.origWidth%4!=0||l.origHeight%4!=0)&&console.warn(`THREE.KTX2Loader: ETC1S and UASTC textures should use multiple-of-four dimensions.`),u>1?(s=l.origWidth,c=l.origHeight):(s=l.width,c=l.height);let d=new Uint8Array(t.getImageTranscodedSizeInBytes(a,n,0,g)),f=t.transcodeImage(d,a,n,e,g,0,-1,-1);if(v===i.HalfFloatType&&(d=new Uint16Array(d.buffer,d.byteOffset,d.byteLength/Uint16Array.BYTES_PER_ELEMENT)),!f)throw r(),Error(`THREE.KTX2Loader: .transcodeImage failed.`);o.push(d)}let d=p(o);n.push({data:d,width:s,height:c}),b.push(d.buffer)}y.push({mipmaps:n,width:s,height:c,format:_,type:v})}return r(),{faces:y,buffers:b,width:s,height:c,hasAlpha:m,dfdFlags:h,format:_,type:v}}let l=[{if:`astcSupported`,basisFormat:[o.UASTC],transcoderFormat:[a.ASTC_4x4,a.ASTC_4x4],engineFormat:[r.RGBA_ASTC_4x4_Format,r.RGBA_ASTC_4x4_Format],engineType:[i.UnsignedByteType],priorityETC1S:1/0,priorityUASTC:1,needsPowerOfTwo:!1},{if:`bptcSupported`,basisFormat:[o.ETC1S,o.UASTC],transcoderFormat:[a.BC7_M5,a.BC7_M5],engineFormat:[r.RGBA_BPTC_Format,r.RGBA_BPTC_Format],engineType:[i.UnsignedByteType],priorityETC1S:3,priorityUASTC:2,needsPowerOfTwo:!1},{if:`dxtSupported`,basisFormat:[o.ETC1S,o.UASTC],transcoderFormat:[a.BC1,a.BC3],engineFormat:[r.RGBA_S3TC_DXT1_Format,r.RGBA_S3TC_DXT5_Format],engineType:[i.UnsignedByteType],priorityETC1S:4,priorityUASTC:5,needsPowerOfTwo:!1},{if:`etc2Supported`,basisFormat:[o.ETC1S,o.UASTC],transcoderFormat:[a.ETC1,a.ETC2],engineFormat:[r.RGB_ETC2_Format,r.RGBA_ETC2_EAC_Format],engineType:[i.UnsignedByteType],priorityETC1S:1,priorityUASTC:3,needsPowerOfTwo:!1},{if:`etc1Supported`,basisFormat:[o.ETC1S,o.UASTC],transcoderFormat:[a.ETC1],engineFormat:[r.RGB_ETC1_Format],engineType:[i.UnsignedByteType],priorityETC1S:2,priorityUASTC:4,needsPowerOfTwo:!1},{if:`pvrtcSupported`,basisFormat:[o.ETC1S,o.UASTC],transcoderFormat:[a.PVRTC1_4_RGB,a.PVRTC1_4_RGBA],engineFormat:[r.RGB_PVRTC_4BPPV1_Format,r.RGBA_PVRTC_4BPPV1_Format],engineType:[i.UnsignedByteType],priorityETC1S:5,priorityUASTC:6,needsPowerOfTwo:!0},{if:`bptcSupported`,basisFormat:[o.UASTC_HDR],transcoderFormat:[a.BC6H],engineFormat:[r.RGB_BPTC_UNSIGNED_Format],engineType:[i.HalfFloatType],priorityHDR:1,needsPowerOfTwo:!1},{basisFormat:[o.ETC1S,o.UASTC],transcoderFormat:[a.RGBA32,a.RGBA32],engineFormat:[r.RGBAFormat,r.RGBAFormat],engineType:[i.UnsignedByteType,i.UnsignedByteType],priorityETC1S:100,priorityUASTC:100,needsPowerOfTwo:!1},{basisFormat:[o.UASTC_HDR],transcoderFormat:[a.RGBA_HALF],engineFormat:[r.RGBAFormat],engineType:[i.HalfFloatType],priorityHDR:100,needsPowerOfTwo:!1}],u={[o.ETC1S]:l.filter(e=>e.basisFormat.includes(o.ETC1S)).sort((e,t)=>e.priorityETC1S-t.priorityETC1S),[o.UASTC]:l.filter(e=>e.basisFormat.includes(o.UASTC)).sort((e,t)=>e.priorityUASTC-t.priorityUASTC),[o.UASTC_HDR]:l.filter(e=>e.basisFormat.includes(o.UASTC_HDR)).sort((e,t)=>e.priorityHDR-t.priorityHDR)};function d(t,n,r,i){let a=u[t];for(let o=0;o<a.length;o++){let s=a[o];if(!(s.if&&!e[s.if])&&s.basisFormat.includes(t)&&!(i&&s.transcoderFormat.length<2)&&!(s.needsPowerOfTwo&&!(f(n)&&f(r))))return{transcoderFormat:s.transcoderFormat[+!!i],engineFormat:s.engineFormat[+!!i],engineType:s.engineType[0]}}throw Error(`THREE.KTX2Loader: Failed to identify transcoding target.`)}function f(e){return e<=2?!0:(e&e-1)==0&&e!==0}function p(e){if(e.length===1)return e[0];let t=0;for(let n=0;n<e.length;n++){let r=e[n];t+=r.byteLength}let n=new Uint8Array(t),r=0;for(let t=0;t<e.length;t++){let i=e[t];n.set(i,r),r+=i.byteLength}return n}};var yd=new Set([E,T,j,k]),bd={109:E,103:j,100:k,97:E,83:j,76:k,91:E,43:E,37:E,22:j,16:j,15:k,9:k,123:T,122:T,152:L,148:oe,153:se,154:ce,155:le,156:ue,[td]:de,158:de,157:de,[nd]:he,166:he,165:he,134:P,133:P,132:N,131:N,138:te,137:te,140:Oe,139:R,142:ke,141:z,146:Te,145:Te,[ed]:ie,[Qu]:ie,[$u]:I,[Zu]:I},xd={109:_,103:_,100:_,97:v,83:v,76:v,91:m,43:d,37:d,22:d,16:d,15:d,9:d,123:S,122:C,152:d,148:d,153:d,154:d,155:d,156:d,[td]:v,158:d,157:d,[nd]:v,166:d,165:d,134:d,133:d,132:d,131:d,138:d,137:d,140:d,139:d,142:d,141:d,146:d,145:d,[ed]:d,[Qu]:d,[$u]:d,[Zu]:d};async function Sd(e){let{vkFormat:t}=e;if(bd[t]===void 0)throw Error(`THREE.KTX2Loader: Unsupported vkFormat: `+t);xd[t]===void 0&&console.warn(`THREE.KTX2Loader: Missing ".type" for vkFormat: `+t);let n;e.supercompressionScheme===2&&(_d||=new Promise(async e=>{let t=new dd;await t.init(),e(t)}),n=await _d);let r=[];for(let i=0;i<e.levels.length;i++){let a=Math.max(1,e.pixelWidth>>i),o=Math.max(1,e.pixelHeight>>i),s=e.pixelDepth?Math.max(1,e.pixelDepth>>i):0,c=e.levels[i],l;if(e.supercompressionScheme===0)l=c.levelData;else if(e.supercompressionScheme===2)l=n.decode(c.levelData,c.uncompressedByteLength);else throw Error(`THREE.KTX2Loader: Unsupported supercompressionScheme.`);let u;u=xd[t]===1015?new Float32Array(l.buffer,l.byteOffset,l.byteLength/Float32Array.BYTES_PER_ELEMENT):xd[t]===1016||xd[t]===1012?new Uint16Array(l.buffer,l.byteOffset,l.byteLength/Uint16Array.BYTES_PER_ELEMENT):xd[t]===35902||xd[t]===35899?new Uint32Array(l.buffer,l.byteOffset,l.byteLength/Uint32Array.BYTES_PER_ELEMENT):l,r.push({data:u,width:a,height:o,depth:s})}let i=e.levelCount===0||r.length>1,s;if(yd.has(bd[t]))s=e.pixelDepth===0?new Xr(r[0].data,e.pixelWidth,e.pixelHeight):new Kt(r[0].data,e.pixelWidth,e.pixelHeight,e.pixelDepth),s.minFilter=i?o:a,s.magFilter=a,s.generateMipmaps=e.levelCount===0;else{if(e.pixelDepth>0)throw Error(`THREE.KTX2Loader: Unsupported pixelDepth.`);s=new Ti(r,e.pixelWidth,e.pixelHeight),s.minFilter=i?u:c,s.magFilter=c}return s.mipmaps=r,s.type=xd[t],s.format=bd[t],s.colorSpace=Cd(e),s.needsUpdate=!0,Promise.resolve(s)}function Cd(e){let t=e.dataFormatDescriptor[0];return t.colorPrimaries===1?t.transferFunction===2?Fe:Ie:t.colorPrimaries===10?t.transferFunction===2?pd:md:(t.colorPrimaries===0||console.warn(`THREE.KTX2Loader: Unsupported color primaries, "${t.colorPrimaries}"`),``)}function wd(e){let t=new ya,i=null,a=!1;try{i=new vd,i.setTranscoderPath(`basis/`),i.detectSupport(e),a=!0}catch(e){i=null,a=!1,console.warn(`[textureLoaders] KTX2 unavailable:`,e)}function o(e,o,s){let{ktx2:l,fallback:d,colorSpace:f=``,anisotropy:p=4,wrapS:m=n,wrapT:h=r}=e,g=e=>(e.wrapS=m,e.wrapT=h,e.anisotropy=p,e.colorSpace=f,e.isCompressedTexture?(e.minFilter=u,e.magFilter=c):(e.minFilter=u,e.magFilter=c,e.generateMipmaps=!0),e.needsUpdate=!0,e),_=()=>{if(!d){s?.(Error(`no fallback texture url`));return}t.load(d,e=>{g(e),o(e,d.endsWith(`.png`)?`png`:d.endsWith(`.jpg`)||d.endsWith(`.jpeg`)?`jpeg`:`unknown`)},void 0,e=>s?.(e))};l&&i&&a?i.load(l,e=>{g(e),o(e,`ktx2`)},void 0,()=>{console.warn(`[textureLoaders] KTX2 failed, fallback: ${d||`(none)`}`),_()}):_()}function s(){try{i?.dispose?.()}catch{}i=null,a=!1}return{textureLoader:t,ktx2Loader:i,get ktx2Supported(){return a},loadTexture:o,dispose:s}}function Td(e){let t=e>>>0;return function(){t|=0,t=t+1831565813|0;let e=Math.imul(t^t>>>15,1|t);return e=e+Math.imul(e^e>>>7,61|e)^e,((e^e>>>14)>>>0)/4294967296}}function Ed(e,t={}){let n=t.count??1e3,r=t.points??14,i=Td(t.seed??1337),a=[{lat:18,lon:-40,strength:1},{lat:-28,lon:95,strength:.85},{lat:42,lon:150,strength:.7}].map(t=>({...t,pos:Dd(t.lat,t.lon,e*1.024)})),o=[];for(let t=0;t<n;t+=1){let t=-70+i()*140,n=i()*360-180,s=.25+i()*.95,c=[],l=Dd(t,n,e*1.024),u=Od(l,i),d=e*.018;for(let t=0;t<r;t+=1){let t=new J;for(let n of a){let r=n.pos.clone().sub(l),i=r.length();if(i<e*.9){let e=l.clone().normalize(),a=new J().crossVectors(e,r).normalize();t.add(a.multiplyScalar(n.strength*.06/(1+i*1.5)))}}u.add(t).normalize();let n=l.clone().normalize();u.projectOnPlane(n).normalize(),l=l.clone().add(u.clone().multiplyScalar(d)),l.setLength(e*1.024),c.push(l.clone())}o.push({points:c,speed:s,phase:i()*Math.PI*2,color:kd(s)})}return o}function Dd(e,t,n){let r=wt.degToRad(e),i=wt.degToRad(t);return new J(n*Math.cos(r)*Math.cos(i),n*Math.sin(r),-n*Math.cos(r)*Math.sin(i))}function Od(e,t){let n=e.clone().normalize(),r=Math.abs(n.y)<.9?new J(0,1,0):new J(1,0,0);return new J().crossVectors(n,r).normalize().applyAxisAngle(n,t()*Math.PI*2)}function kd(e){let t=Math.min(1,Math.max(0,(e-.25)/.95)),n,r,i;if(t<.5){let e=t/.5;n=Ad(.25,.65,e),r=Ad(.6,.55,e),i=Ad(.65,.25,e)}else{let e=(t-.5)/.5;n=Ad(.65,.65,e),r=Ad(.55,.22,e),i=Ad(.25,.15,e)}return[n,r,i]}function Ad(e,t,n){return e+(t-e)*n}function jd(e,t={}){let n=t.count??cu.windSegments,r=t.points??14,i=Array.isArray(t.segments)&&t.segments.length>0?t.segments:Ed(e*1.06,{count:n,points:r,seed:cu.seed}),a=[],o=[],s=[];for(let e of i){let t=e.color;for(let n=0;n<e.points.length-1;n+=1){let r=e.points[n],i=e.points[n+1],c=n/(e.points.length-1),l=(n+1)/(e.points.length-1);a.push(r.x,r.y,r.z,i.x,i.y,i.z),o.push(t[0],t[1],t[2],t[0],t[1],t[2]),s.push(c,l)}}let c=new wr;c.setAttribute(`position`,new fr(a,3)),c.setAttribute(`color`,new fr(o,3)),c.setAttribute(`aProgress`,new fr(s,1));let l=new Wi({transparent:!0,depthWrite:!0,blending:1,uniforms:{uTime:{value:0},uFlow:{value:.55},uBase:{value:.12},uDepthFade:{value:1},uSunDir:{value:new J(1,0,0)}},vertexShader:`
    ...
    `});return{group:new _i(c,l),count:i.length,update(e){l.uniforms.uTime.value=e},dispose(){c.dispose(),l.dispose()}}}function Md(e,t={}){let n=t.count??cu.satelliteCount,r=Td((t.seed??cu.seed)+7777),i=new Float32Array(n*3),a=new Float32Array(n),o=new Float32Array(n),s=Math.PI*(3-Math.sqrt(5)),c=Math.PI*2;for(let t=0;t<n;t+=1){let l=1-t/Math.max(1,n-1)*2,u=Math.sqrt(Math.max(0,1-l*l)),d=s*t,f=e+e*.06+r()*e*.14;i[t*3]=Math.cos(d)*u*f,i[t*3+1]=l*f,i[t*3+2]=Math.sin(d)*u*f,a[t]=.6+r()*.8,o[t]=r()*c}return{positions:i,sizes:a,phases:o}}function Nd(e,t={}){let n=t.count??cu.satelliteCount,{positions:r,sizes:i,phases:a}=Md(e*4,{count:n,seed:cu.seed}),o=new wr;o.setAttribute(`position`,new fr(r,3)),o.setAttribute(`aSize`,new fr(i,1)),o.setAttribute(`aPhase`,new fr(a,1));let s=new Wi({transparent:!0,depthWrite:!1,blending:2,uniforms:{uTime:{value:0},uOpacity:{value:.9},uSizeBase:{value:.075},uPixelRatio:{value:Math.min(window.devicePixelRatio,cu.pixelRatioCap)}},vertexShader:`
      uniform float uTime;
    ...
    `}),c=new Ci(o,s);return{group:c,count:n,update(e,t){c.rotation.y+=t*.02,c.rotation.x+=t*.006,s.uniforms.uTime.value=e},dispose(){o.dispose(),s.dispose()}}}var Pd={loading:`loading`,ready:`ready`,missing:`missing`};function Fd(e,t,n,r,i){if(!e)return 0;let a=(r+180)/360,o=(90-i)/180,s=Math.floor(a*t),c=Math.floor(o*n);return s=(s%t+t)%t,c<0&&(c=0),c>n-1&&(c=n-1),e[c*t+s]/255}function Id(e,t,n,r,i){let a=[];for(let o=0;o<e.length;o+=1){let[s,c]=e[o],l=wt.degToRad(c),u=wt.degToRad(s),d=Fd(n,r,i,s,c),f=t+0+d*du+.004;a.push(f*Math.cos(l)*Math.cos(u),f*Math.sin(l),-f*Math.cos(l)*Math.sin(u))}return a}function Ld(e,t,n,r,i,a,o){let s=new Sn,c=[{segs:e,color:new Z(`#5a7a8a`),opacity:.55},{segs:t,color:new Z(`#4a6a7a`),opacity:.35},{segs:n,color:new Z(`#8a7a5a`),opacity:.5}],l=[];for(let e of c){let t=[];for(let n of e.segs||[]){if(n.length<2)continue;let e=Id(n,r,i,a,o);for(let n=0;n+5<e.length;n+=3)t.push(e[n],e[n+1],e[n+2],e[n+3],e[n+4],e[n+5])}if(t.length===0)continue;let n=new wr;n.setAttribute(`position`,new fr(t,3));let c=new ai({color:e.color,transparent:!0,opacity:e.opacity,depthWrite:!1,blending:1}),u=new _i(n,c);u.renderOrder=3,s.add(u),l.push({geometry:n,material:c,count:(e.segs||[]).length})}return{group:s,status:l.length>0?Pd.ready:Pd.missing,countrySegmentCount:e?e.length:0,stateSegmentCount:t?t.length:0,chinaSegmentCount:n?n.length:0,update(){},dispose(){for(let e of l)e.geometry.dispose(),e.material.dispose()}}}async function Rd(){for(let e of[`assets/earth/etopo1-heightmap-2880x1440.png`,`assets/earth/etopo1-heightmap-720x360.png`])try{let t=await fetch(e,{cache:`no-cache`});if(!t.ok)continue;let n=await t.blob(),r=await createImageBitmap(n),i=document.createElement(`canvas`);i.width=r.width,i.height=r.height;let a=i.getContext(`2d`,{willReadFrequently:!0});a.drawImage(r,0,0);let{data:o}=a.getImageData(0,0,r.width,r.height),s=new Uint8Array(r.width*r.height);for(let e=0;e<s.length;e+=1)s[e]=o[e*4];return console.log(`[boundaries] heightmap ${r.width}x${r.height} from ${e}`),{data:s,width:r.width,height:r.height}}catch{}return console.warn(`[boundaries] heightmap decode failed, lines will float`),null}async function zd(e){try{let t=await fetch(`assets/boundaries/manifest.json`,{cache:`no-cache`});if(!t.ok)return Bd(`manifest HTTP `+t.status);let n=await t.json(),r=n.entries||[],i=r.find(e=>e.kind===`countries`),a=r.find(e=>e.kind===`states_provinces`),o=r.find(e=>e.kind===`china_provinces`),[s,c,l,u]=await Promise.all([i?fetch(`assets/boundaries/`+i.asset).then(e=>e.json()):Promise.resolve({segments:[]}),a?fetch(`assets/boundaries/`+a.asset).then(e=>e.json()):Promise.resolve({segments:[]}),o?fetch(`assets/boundaries/`+o.asset).then(e=>e.json()):Promise.resolve({segments:[]}),Rd()]),d=u?u.data:null,f=Ld(s.segments||[],c.segments||[],l.segments||[],e,d,u?u.width:720,u?u.height:360);return f.manifest=n,f}catch(e){return Bd(String(e))}}function Bd(e){let t=Ld([],[],[],2,null,720,360);return t.status=Pd.missing,t.missingReason=e,t}var Vd={loading:`loading`,ready:`ready`,missing:`missing`};async function Hd(e){let t=document.createElement(`div`);t.className=`globe-labels`,t.style.position=`absolute`,t.style.inset=`0`,t.style.pointerEvents=`none`,t.style.zIndex=`5`;let n=[],r=Vd.loading,i=null;try{let e=await fetch(`assets/labels/labels-110m.json`,{cache:`no-cache`});if(!e.ok)r=Vd.missing,i=`HTTP `+e.status;else{let t=await e.json();n=Array.isArray(t.labels)?t.labels:[],r=Vd.ready}}catch(e){r=Vd.missing,i=String(e)}let a=n.map(e=>{let n=document.createElement(`div`);return n.className=`globe-label`+(e.capital?` globe-label--capital`:``),n.textContent=e.nameZh?`${e.name} / ${e.nameZh}`:e.name,n.dataset.bilingual=e.nameZh?`1`:`0`,n.style.display=`none`,t.appendChild(n),{el:n,label:e,pos:new J}});return{container:t,status:r,missingReason:i,labelCount:n.length,bilingualCount:n.filter(e=>e.nameZh).length,update(e,t,n,r=0){if(a.length===0)return;let i=new J(0,1,0),o=[],s=new J;e.getWorldDirection(s);for(let s of a){let{label:a,el:c,pos:l}=s,u=wt.degToRad(a.lat),d=wt.degToRad(a.lon),f=n;l.set(f*Math.cos(u)*Math.cos(d),f*Math.sin(u),-f*Math.cos(u)*Math.sin(d)),r!==0&&l.applyAxisAngle(i,r);let p=l.clone().normalize(),m=e.position.clone().sub(l).normalize();if(p.dot(m)<.1){c.style.display=`none`;continue}let h=l.clone().project(e),g=(h.x*.5+.5)*t.width,_=(-h.y*.5+.5)*t.height;if(g<0||_<0||g>t.width||_>t.height){c.style.display=`none`;continue}let v=c._w,y=c._h;if(v==null){c.style.display=`block`;let e=c.getBoundingClientRect();v=c._w=e.width||40,y=c._h=e.height||12}let b={x:g-v/2,y:_-y/2,w:v,h:y},x=!1;for(let e of o)if(!(b.x+b.w<=e.x||e.x+e.w<=b.x||b.y+b.h<=e.y||e.y+e.h<=b.y)){x=!0;break}if(x){c.style.display=`none`;continue}c.style.display=`block`,c.style.left=`${g-v/2}px`,c.style.top=`${_-y/2}px`,c.style.opacity=String(wt.clamp(p.dot(m)*1.4,.2,1)),o.push(b)}},dispose(){for(let e of a)e.el.remove();t.parentNode&&t.parentNode.removeChild(t)}}}var Ud=[`schemaVersion`,`source`,`producer`,`access`,`variables`,`units`,`timeUtc`,`grid`,`u`,`v`,`speedStats`,`preprocess`,`licenseNotice`];function Wd(e){let t=[];if(!e||typeof e!=`object`)return{ok:!1,errors:[`frame is not an object`],stats:null};for(let n of Ud)n in e||t.push(`missing field: ${n}`);e.schemaVersion&&e.schemaVersion!==`era5-wind-frame-v1`&&t.push(`unexpected schemaVersion: ${e.schemaVersion}`);let n=String(e.source??``).toLowerCase();n&&!n.includes(`era5`)&&t.push(`source does not declare ERA5: ${e.source}`),e.producer&&!/copernicus|ecmwf/i.test(String(e.producer))&&t.push(`producer must reference Copernicus/ECMWF: ${e.producer}`);let r=e.grid,i=0,a=0;r&&typeof r==`object`&&(i=Number(r.width)||0,a=Number(r.height)||0,(!Array.isArray(r.lon)||r.lon.length!==2)&&t.push(`grid.lon must be [min,max]`),(!Array.isArray(r.lat)||r.lat.length!==2)&&t.push(`grid.lat must be [min,max]`));let o=e.u,s=e.v;!Array.isArray(o)||!Array.isArray(s)?t.push(`u and v must be arrays`):o.length===s.length?i&&a&&o.length!==i*a&&t.push(`u length ${o.length} != width*height ${i*a}`):t.push(`u/v length mismatch: ${o.length} vs ${s.length}`);let c=null;if(Array.isArray(o)&&Array.isArray(s)&&o.length===s.length&&o.length>0){let e=1/0,n=-1/0,r=0,i=0;for(let t=0;t<o.length;t+=1){let a=o[t],c=s[t];if(!Number.isFinite(a)||!Number.isFinite(c)){i+=1;continue}let l=Math.hypot(a,c);l<e&&(e=l),l>n&&(n=l),r+=l}let a=o.length-i;a<=0?t.push(`no finite wind values`):c={min:e,max:n,mean:r/a,nonFinite:i,count:a}}if(e.speedStats){let n=e.speedStats;for(let e of[`min`,`max`,`mean`,`p95`])n[e]!==void 0&&!Number.isFinite(n[e])&&t.push(`speedStats.${e} not finite`);Number.isFinite(n.min)&&Number.isFinite(n.max)&&Number.isFinite(n.mean)&&!(n.min<=n.mean&&n.mean<=n.max)&&t.push(`speedStats not ordered: min <= mean <= max violated`),Number.isFinite(n.p95)&&Number.isFinite(n.mean)&&n.p95<n.mean&&t.push(`speedStats p95 < mean`)}return{ok:t.length===0,errors:t,stats:c}}var Gd=`data/era5/manifest.json`;function Kd(e,t){return new URL(e,t).href}async function qd(){let e,t=new URL(Gd,window.location.href).href;try{let n=await fetch(t,{cache:`no-cache`});if(!n.ok)return{status:`missing`,reason:`manifest fetch failed: HTTP ${n.status}`};e=await n.json()}catch(e){return{status:`missing`,reason:`manifest fetch error: ${String(e)}`}}return!e||!e.frame?{status:`missing`,reason:`manifest has no frame path`}:Jd(e.frame,t)}async function Jd(e,t){let n=Kd(e,t),r;try{let e=await fetch(n,{cache:`no-cache`});if(!e.ok)return{status:`missing`,reason:`frame fetch failed: HTTP ${e.status}`};r=await e.json()}catch(e){return{status:`missing`,reason:`frame fetch error: ${String(e)}`}}let{ok:i,errors:a,stats:o}=Wd(r);return i?{status:`era5`,frame:r,stats:o}:{status:`missing`,reason:`frame invalid: ${a.join(`; `)}`}}async function Yd(){let e=new URL(Gd,window.location.href).href,t;try{let n=await fetch(e,{cache:`no-cache`});if(!n.ok)return{status:`missing`,reason:`manifest fetch failed: HTTP ${n.status}`};t=await n.json()}catch(e){return{status:`missing`,reason:`manifest fetch error: ${String(e)}`}}let n=Array.isArray(t.frames)&&t.frames.length>0?t.frames.map(e=>e.file):t.frame?[t.frame]:[];if(n.length===0)return{status:`missing`,reason:`manifest has no frames`};let r=[];for(let t of n){let n=await Jd(t,e);n.status===`era5`&&r.push({frame:n.frame,stats:n.stats,timeUtc:n.frame.timeUtc})}return r.length===0?{status:`missing`,reason:`no valid frames loaded`}:{status:`era5`,frames:r,count:r.length}}function Xd(e,t,n={}){if(!e||!Array.isArray(e.u)||!Array.isArray(e.v))return[];let r=e.grid;if(!r||!r.lon||!r.lat)return[];let i=Number(r.width)||0,a=Number(r.height)||0;if(i<=0||a<=0||e.u.length!==i*a)return[];let o=r.lon[0],s=r.lon[1],c=r.lat[0],l=r.lat[1],u=s-o,d=l-c,f=n.count??1e3,p=n.points??14,m=Td((n.seed??1337)+31),h=e.speedStats||{},g=Number.isFinite(h.p5)?h.p5:1.5,_=Number.isFinite(h.p95)?h.p95:12,v=t*1.065,y=[];for(let t=0;t<f;t+=1){let t=c+m()*d,n=o+m()*u,r=[],f=0;for(let u=0;u<p;u+=1){let{u,v:d}=Zd(e.u,e.v,i,a,t,n,o,s,c,l),p=Math.hypot(u,d);if(!Number.isFinite(p))break;p>f&&(f=p);let m=.9/Math.max(.6,p);n+=u*m,t+=d*m,n=$d(n,o,s),t>l&&(t=l),t<c&&(t=c),r.push(Qd(t,n,v))}r.length<2||y.push({points:r,speed:f,color:tf(f,g,_),phase:m()*Math.PI*2})}return y}function Zd(e,t,n,r,i,a,o,s,c,l){let u=(a-o)/(s-o)*(n-1),d=c,f=l,p=(f-i)/(f-d)*(r-1),m=Math.floor(ef(u,0,n-1)),h=Math.floor(ef(p,0,r-1)),g=Math.min(n-1,m+1),_=Math.min(r-1,h+1),v=ef(u-m,0,1),y=ef(p-h,0,1),b=h*n+m,x=h*n+g,S=_*n+m,C=_*n+g,w=e[b]??0,T=e[x]??0,E=e[S]??0,D=e[C]??0,O=t[b]??0,k=t[x]??0,A=t[S]??0,j=t[C]??0,ee=(1-v)*(1-y),M=v*(1-y),N=(1-v)*y,P=v*y;return{u:ee*w+M*T+N*E+P*D,v:ee*O+M*k+N*A+P*j}}function Qd(e,t,n){let r=wt.degToRad(e),i=wt.degToRad(t);return new J(n*Math.cos(r)*Math.cos(i),n*Math.sin(r),-n*Math.cos(r)*Math.sin(i))}function $d(e,t,n){let r=n-t,i=e;for(;i<t;)i+=r;for(;i>n;)i-=r;return i}function ef(e,t,n){return e<t?t:e>n?n:e}function tf(e,t,n){let r=ef((e-t)/Math.max(.001,n-t),0,1),i=[[0,[.43,.97,1]],[.35,[.92,.97,1]],[.7,[1,.82,.32]],[1,[1,.32,.22]]],a=i[0],o=i[i.length-1];for(let e=0;e<i.length-1;e+=1)if(r>=i[e][0]&&r<=i[e+1][0]){a=i[e],o=i[e+1];break}let s=(r-a[0])/Math.max(1e-4,o[0]-a[0]);return[a[1][0]+(o[1][0]-a[1][0])*s,a[1][1]+(o[1][1]-a[1][1])*s,a[1][2]+(o[1][2]-a[1][2])*s]}var nf=`loading`,rf=null,af=null;function of(e){nf=`era5`,rf=e,af=null}function sf(){nf=`devSynthetic`}function cf(e){nf=`missing`,af=e??`no wind data`}function lf(){nf=`loading`}function uf(){return{status:nf,isEra5:nf===`era5`,frame:rf,reason:af}}function df(e){let t=new Ao(e),n=new An;n.background=new Z(`#010308`);let r=new Ia(`#c8d8ff`,1.6);r.position.set(4,2,6);let i=new Ia(`#1a2a48`,.55);i.position.set(-5,-1,-3);let a=new xa(`#5a7aaa`,`#02040a`,.7);n.add(r,i,a);let o=new Float32Array(400*3);for(let e=0;e<400;e+=1){let t=Math.random(),n=Math.random(),r=2*Math.PI*t,i=Math.acos(2*n-1);o[e*3]=8*Math.sin(i)*Math.cos(r),o[e*3+1]=8*Math.sin(i)*Math.sin(r),o[e*3+2]=8*Math.cos(i)}let s=new wr;s.setAttribute(`position`,new lr(o,3));let c=new Ci(s,new vi({color:16777215,size:.04,sizeAttenuation:!0}));n.add(c);let l=t.fromScene(n,.04).texture;return s.dispose(),c.material.dispose(),t.dispose(),l}var ff=-Math.PI*.5;function pf(e,t,n){let r=wt.degToRad(t),i=wt.degToRad(e);return new J(n*Math.cos(r)*Math.cos(i),n*Math.sin(r),-n*Math.cos(r)*Math.sin(i))}var mf=new class{constructor(e){this.canvas=e,this.scene=new An,this.camera=new Na(42,1,.1,100),this.renderer=null,this.composer=null,this.controls=null,this.root=new Sn,this.clock=new no,this.resizeObserver=null,this.layers=[],this.quality=cu.defaultQuality,this.paused=!1,this.postprocessingEnabled=!1,this.currentWindCount=0,this.currentSatelliteCount=0,this.frozenElapsed=0,this.frozenDelta=0,this.era5Frame=null,this.era5Stats=null,this.windLayerKind=`devSynthetic`,this.era5Series=[],this.frameIndex=0,this.windPlaying=!0,this.frameAccum=0,this.frameInterval=6}init(){this.renderer=new Cl({canvas:this.canvas,antialias:!0,alpha:!1});let e=new URLSearchParams(window.location.search).get(`lowres`)===`1`;if(this.testScale=e?.5:1,this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,cu.pixelRatioCap)*this.testScale),this.renderer.outputColorSpace=Fe,this.renderer.toneMapping=4,this.renderer.toneMappingExposure=1.08,this.scene.environment=df(this.renderer),this.scene.environmentIntensity=.28,this.scene.background=new Z(`#02040a`),this.camera.position.set(.8,1.2,cu.cameraDistance),this.controls=new Pl(this.camera,this.canvas),this.controls.enableDamping=!0,this.controls.dampingFactor=.06,this.controls.enablePan=!1,this.controls.minDistance=2.18,this.controls.maxDistance=12,this.controls.zoomSpeed=.8,this.sunLight=new Ia(`#fff4e4`,2.9),this.scene.add(this.sunLight,this.sunLight.target),this.nightFill=new xa(`#8ea6c8`,`#050810`,1.15),this.scene.add(this.nightFill,this.root),this.nightAmbient=new La(`#5c6a82`,.55),this.scene.add(this.nightAmbient),this.nightFillEnabled=!0,this.updateSunFromTime(this.era5Frame?.timeUtc??null),this.root.rotation.y=ff,this.textureLoaders=wd(this.renderer),this.buildLayers(),new URLSearchParams(window.location.search).get(`nobloom`)===`1`)this.postprocessingEnabled=!1,this.composer=null;else try{this.composer=new tu(this.renderer),this.composer.addPass(new nu(this.scene,this.camera)),this.composer.addPass(new iu(new q(1,1),.36,.58,.42)),this.composer.addPass(new ou),this.postprocessingEnabled=!0}catch(e){this.postprocessingEnabled=!1,this.composer=null,console.warn(`[EarthScene] postprocessing unavailable, falling back to direct render`,e)}this.resizeObserver=new ResizeObserver(()=>this.resize()),this.resizeObserver.observe(this.canvas.parentElement),this.resize(),this.animate(),this.attachTestHook(),zu(()=>this.updateEarthMapBadge()),this.boundariesStatus=`loading`,this.loadBoundaries(),this.labelsStatus=`loading`,this.loadLabels(),lf(),this.loadEra5()}async loadLabels(){try{let e=await Hd(cu.radius);this.labelsLayer=e,this.labelsStatus=e.status,this.canvas&&this.canvas.parentElement&&this.canvas.parentElement.appendChild(e.container),this.labelsInfo={labelCount:e.labelCount,bilingualCount:e.bilingualCount,source:`naturalEarth110m`}}catch(e){this.labelsStatus=`missing`,console.warn(`[EarthScene] labels load failed:`,e)}}async loadBoundaries(){try{let e=await zd(cu.radius);this.boundariesLayer=e,this.root.add(e.group),this.boundariesStatus=e.status,this.boundariesLayerInfo={countrySegmentCount:e.countrySegmentCount,stateSegmentCount:e.stateSegmentCount,chinaSegmentCount:e.chinaSegmentCount??0,source:`naturalEarth110m+10m`}}catch(e){this.boundariesStatus=`missing`,console.warn(`[EarthScene] boundaries load failed:`,e)}}async loadEra5(){try{let e=await Yd();if(e.status===`era5`&&e.frames.length>0){this.era5Series=e.frames,this.frameIndex=0;let t=e.frames[0];this.era5Frame=t.frame,this.era5Stats=t.stats,this.rebuildWindLayerAsEra5()}else{let e=await qd();e.status===`era5`?(this.era5Series=[{frame:e.frame,stats:e.stats,timeUtc:e.frame.timeUtc}],this.frameIndex=0,this.era5Frame=e.frame,this.era5Stats=e.stats,this.rebuildWindLayerAsEra5()):(sf(),this.windLayerKind=`devSynthetic`,this.updateWindSourceBadge(),console.warn(`[EarthScene] ERA5 frame unavailable, using devSynthetic wind:`,e.reason))}}catch(e){cf(String(e)),this.updateWindSourceBadge(),console.warn(`[EarthScene] ERA5 load error:`,e)}}stepWindFrame(e=1){if(this.era5Series.length<2)return this.frameIndex;let t=(this.frameIndex+e+this.era5Series.length)%this.era5Series.length;this.frameIndex=t;let n=this.era5Series[t];return this.era5Frame=n.frame,this.era5Stats=n.stats,this.currentFrameTimeUtc=n.timeUtc,this.rebuildWindLayerAsEra5(),t}setWindPlaying(e){this.windPlaying=!!e}rebuildWindLayerAsEra5(){if(!this.era5Frame)return;let e=su[this.quality]??su[cu.defaultQuality],t=Xd(this.era5Frame,cu.radius,{count:e.windSegments,points:e.windPoints,seed:cu.seed});if(!t||t.length===0){sf(`traceWindStreamlines returned no segments`),this.updateWindSourceBadge();return}this.windLayer&&(this.windLayer.dispose?.(),this.root.remove(this.windLayer.group)),this.windLayer=jd(cu.radius,{count:e.windSegments,points:e.windPoints,segments:t}),this.root.add(this.windLayer.group),this.currentSunDirection&&this._syncWindSunDir(new J(...this.currentSunDirection)),this.layers=[this.windLayer,this.satelliteLayer],this.currentWindCount=this.windLayer.count??t.length,this.windLayerKind=`era5`,this.currentFrameTimeUtc=this.era5Frame.timeUtc,of(this.era5Frame),this.updateWindSourceBadge()}updateWindSourceBadge(){let e=typeof document<`u`?document.querySelector(`#wind-source`):null;if(!e)return;let{status:t,isEra5:n}=uf();e.textContent=n?`ERA5 风场`:t===`missing`?`ERA5 数据缺失`:`合成风场（dev）`,e.dataset.source=t}buildLayers(){if(this.rebuildEarthLayer(),this.atmosphereMesh=Yu(cu.radius),this.cloudsLayer=null,this.root.add(this.atmosphereMesh),this.currentSunDirection){let e=new J(...this.currentSunDirection);this._syncAtmosphereSunDir(e)}this.buildDynamicLayers()}rebuildEarthLayer(){if(this.earthMesh){this.root.remove(this.earthMesh),this.earthMesh.geometry?.dispose?.();let e=this.earthMesh.material;if(e){for(let t of[`map`,`displacementMap`,`normalMap`,`roughnessMap`,`clearcoatMap`,`emissiveMap`])e[t]?.dispose?.();e.dispose?.()}this.earthMesh=null}this.earthMesh=Wu(cu.radius,{quality:this.quality,loaders:this.textureLoaders}),this.root.add(this.earthMesh),this.currentSunDirection&&this._syncEarthSunDir(new J(...this.currentSunDirection))}buildDynamicLayers(){let e=su[this.quality]??su[cu.defaultQuality];this.currentPreset=e;let t=jd(cu.radius,{count:e.windSegments,points:e.windPoints}),n=Nd(cu.radius,{count:e.satelliteCount});this.windLayer=t,this.satelliteLayer=n,this.root.add(t.group,n.group),this.currentSunDirection&&this._syncWindSunDir(new J(...this.currentSunDirection)),this.layers=[t,n],this.currentWindCount=t.count??0,this.currentSatelliteCount=n.count??0,this.renderer&&this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,e.pixelRatioCap))}disposeDynamicLayers(){for(let e of this.layers)e.dispose?.(),e.group&&this.root.remove(e.group);this.layers=[],this.windLayer=null,this.satelliteLayer=null}resize(){let e=this.canvas.parentElement.getBoundingClientRect(),t=Math.max(320,Math.floor(e.width)),n=Math.max(320,Math.floor(e.height)),r=Math.floor(t*this.testScale),i=Math.floor(n*this.testScale);this.camera.aspect=r/i,this.camera.updateProjectionMatrix(),this.renderer.setSize(r,i,!1),this.canvas.style.width=`${t}px`,this.canvas.style.height=`${n}px`,this.composer&&this.composer.setSize(r,i)}animate(){if(requestAnimationFrame(()=>this.animate()),this.renderFrozen)return;let e=this.clock.getElapsedTime(),t=this.clock.getDelta(),n=this.paused?this.frozenElapsed:e,r=this.paused?0:t;this.paused||(this.frozenElapsed=e),this.root.rotation.y+=r*.08,this.era5Series.length>1&&this.windPlaying&&!this.paused&&!this.renderFrozen&&(this.frameAccum+=r,this.frameAccum>=this.frameInterval&&(this.frameAccum=0,this.stepWindFrame(1)));let i=this.currentFrameTimeUtc??this.era5Frame?.timeUtc??null;if(i!==this._lastSunTime&&(this._lastSunTime=i,this.updateSunFromTime(i)),this.currentSunDirection){let e=new J(...this.currentSunDirection);this._syncEarthSunDir(e),this._syncAtmosphereSunDir(e)}for(let e of this.layers)e.update?.(n,r);if(this.controls.update(),this.labelsLayer){let e=this.canvas.getBoundingClientRect();this.labelsLayer.update(this.camera,e,cu.radius,this.root.rotation.y)}this.composer?this.composer.render():this.renderer.render(this.scene,this.camera)}setPaused(e){this.paused=!!e}setRenderFreeze(e){this.renderFrozen=!!e,this.renderFrozen&&(this.composer?this.composer.render():this.renderer.render(this.scene,this.camera))}setQuality(e){su[e]&&e!==this.quality&&(this.quality=e,this.rebuildEarthLayer(),this.disposeDynamicLayers(),this.buildDynamicLayers())}resetCamera(){this.camera.position.set(.8,1.2,cu.cameraDistance),this.controls.target.set(0,0,0),this.controls.update(),this.root.rotation.y=ff}updateSunFromTime(e){let t=12;if(typeof e==`string`){let n=/T(\d{2}):(\d{2})/.exec(e);n&&(t=Number(n[1])+Number(n[2])/60)}let n=pf(-15*(t-12),18,1),r=this.camera.position.length()+10;this.sunLight.position.copy(n.clone().multiplyScalar(r)),this.sunLight.target.position.set(0,0,0),this.sunLight.target.updateMatrixWorld(),this.currentSunDirection=[n.x,n.y,n.z],this._syncWindSunDir(n),this._syncEarthSunDir(n),this._syncAtmosphereSunDir(n)}_syncEarthSunDir(e){let t=this.earthMesh?.material?.userData?.shader;t?.uniforms?.uSunDir&&t.uniforms.uSunDir.value.copy(e)}_syncAtmosphereSunDir(e){let t=this.atmosphereMesh;t&&t.traverse(t=>{t.isMesh&&t.material?.uniforms?.uSunDir&&t.material.uniforms.uSunDir.value.copy(e)})}_syncWindSunDir(e){this.windLayer?.group?.material?.uniforms?.uSunDir&&this.windLayer.group.material.uniforms.uSunDir.value.copy(e)}updateEarthMapBadge(){let e=typeof document<`u`?document.querySelector(`#earth-map-source`):null;if(!e)return;let t=Tu();e.textContent=t===`nasaBlueMarble`?`NASA Blue Marble`:`程序化纹理（fallback）`,e.dataset.source=t}attachTestHook(){typeof window>`u`||(window.__viz={ready:!0,paused:()=>this.paused,quality:()=>this.quality,drawCalls:()=>this.renderer.info.render.calls,satelliteCount:()=>this.currentSatelliteCount,windCount:()=>this.currentWindCount,cameraDistance:()=>this.camera.position.length(),postprocessing:()=>this.postprocessingEnabled,windSource:()=>uf().status,windLayerKind:()=>this.windLayerKind,windFrameTime:()=>this.era5Frame?.timeUtc??null,windFrameStats:()=>this.era5Stats??null,era5Ready:()=>uf().isEra5,windFrameCount:()=>this.era5Series.length,windFrameIndex:()=>this.frameIndex,windPlaying:()=>this.windPlaying,stepWindFrame:e=>this.stepWindFrame(e),setWindPlaying:e=>this.setWindPlaying(e),earthMapReady:()=>Eu(),lightingMode:()=>`realisticSun`,nightFillEnabled:()=>this.nightFillEnabled,sunDirection:()=>this.currentSunDirection??[1,0,0],setRenderFreeze:e=>this.setRenderFreeze(e),earthMapSource:()=>Tu(),earthMapAttribution:()=>Ru(),materialMode:()=>ku(),oceanSpecularEnabled:()=>Au(),environmentKind:()=>`deepSpacePMREM`,atmosphereMode:()=>Ju(),nightLightsEnabled:()=>ju(),nightLightsSource:()=>Mu(),textureQuality:()=>Nu(),albedoResolution:()=>Pu(),normalResolution:()=>Fu(),heightmapResolution:()=>Iu(),textureEncoding:()=>Lu(),ktx2Supported:()=>!!this.textureLoaders?.ktx2Supported,cloudsEnabled:()=>!1,cloudsSource:()=>`none`,cloudsEncoding:()=>`none`,terrainReady:()=>Du(),terrainSource:()=>Ou(),terrainDisplacementScale:()=>du,boundariesStatus:()=>this.boundariesStatus,boundariesInfo:()=>this.boundariesLayerInfo??null,labelsStatus:()=>this.labelsStatus,labelsInfo:()=>this.labelsInfo??null,visibleLabelCount:()=>document?document.querySelectorAll(`.globe-label:not([style*='display: none'])`).length:0,setPaused:e=>this.setPaused(e),setQuality:e=>this.setQuality(e),resetCamera:()=>this.resetCamera()})}}(document.querySelector(`#globe-canvas`));mf.init();var hf=document.querySelector(`#btn-pause`),gf=document.querySelector(`#btn-reset`),_f=document.querySelector(`#select-quality`);function vf(){let e=mf.paused;hf.textContent=e?`播放`:`暂停`,hf.setAttribute(`aria-pressed`,String(e))}hf.addEventListener(`click`,()=>{mf.setPaused(!mf.paused),vf()}),gf.addEventListener(`click`,()=>{mf.resetCamera()});var yf=document.querySelector(`#btn-wind-step`),bf=document.querySelector(`#btn-wind-play`);function xf(){let e=mf.windPlaying;bf.textContent=e?`风场自动播放`:`风场已暂停`,bf.setAttribute(`aria-pressed`,String(e))}yf.addEventListener(`click`,()=>{mf.stepWindFrame(1)}),bf.addEventListener(`click`,()=>{mf.setWindPlaying(!mf.windPlaying),xf()}),xf(),_f.addEventListener(`change`,()=>{mf.setQuality(_f.value),mf.updateWindSourceBadge?.()});function Sf(e){document.body.classList.toggle(`demo-mode`,e)}var Cf=!1;window.addEventListener(`keydown`,e=>{e.key===`h`&&(Cf=!Cf,Sf(Cf))}),window.__viz=window.__viz||{},window.__viz.setDemoMode=Sf,window.__viz.demoMode=()=>document.body.classList.contains(`demo-mode`),vf();