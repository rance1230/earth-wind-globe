...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Vo(e,t,n){let r=new Float32Array(Do),i=new q(0,1,0);return new Zi({name:`SphericalGaussianBlur`,defines:{n:Do,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Wo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ho(){return new Zi({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Wo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Uo(){return new Zi({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Wo(),fragmentShader:`
	...
	`}var Go=class extends Gt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Fi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},du=class extends $l{constructor(){super(),this.isOutputPass=!0,this.uniforms=Ji.clone(uu.uniforms),this.material=new Qi({name:uu.name,uniforms:this.uniforms,vertexShader:uu.vertexShader,fragmentShader:uu.fragmentShader}),this._fsQuad=new nu(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},Y.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},fu=class extends jn{constructor(){super(),this.name=`RoomEnvironment`,this.position.y=-3.5;let e=new Bi;e.deleteAttribute(`uv`);let t=new $i({side:1}),n=new $i,r=new za(16777215,900,28,2);r.position.set(.418,16.199,.3),this.add(r);let i=new Jr(e,t);i.position.set(-.757,13.219,.717),i.scale.set(31.713,28.305,28.591),this.add(i);let a=new oi(e,n,6),o=new Sn;o.position.set(-10.906,2.009,1.846),o.rotation.set(0,-.195,0),o.scale.set(2.328,7.905,4.651),o.updateMatrix(),a.setMatrixAt(0,o.matrix),o.position.set(-5.607,-.754,-.758),o.rotation.set(0,.994,0),o.scale.set(1.97,1.534,3.955),o.updateMatrix(),a.setMatrixAt(1,o.matrix),o.position.set(6.167,.857,7.803),o.rotation.set(0,.561,0),o.scale.set(3.927,6.285,3.687),o.updateMatrix(),a.setMatrixAt(2,o.matrix),o.position.set(-2.017,.018,6.124),o.rotation.set(0,.333,0),o.scale.set(2.002,4.566,2.064),o.updateMatrix(),a.setMatrixAt(3,o.matrix),o.position.set(2.291,-.756,-2.621),o.rotation.set(0,-.286,0),o.scale.set(1.546,1.552,1.496),o.updateMatrix(),a.setMatrixAt(4,o.matrix),o.position.set(-2.193,-.369,-5.547),o.rotation.set(0,.516,0),o.scale.set(3.875,3.487,2.986),o.updateMatrix(),a.setMatrixAt(5,o.matrix),this.add(a);let s=new Jr(e,pu(50));s.position.set(-16.116,14.37,8.208),s.scale.set(.1,2.428,2.739),this.add(s);let c=new Jr(e,pu(50));c.position.set(-16.109,18.021,-8.207),c.scale.set(.1,2.425,2.751),this.add(c);let l=new Jr(e,pu(17));l.position.set(14.904,12.198,-1.832),l.scale.set(.15,4.265,6.331),this.add(l);let u=new Jr(e,pu(43));u.position.set(-.462,8.89,14.52),u.scale.set(4.38,5.441,.088),this.add(u);let d=new Jr(e,pu(20));d.position.set(3.235,11.486,-12.541),d.scale.set(2.5,2,.1),this.add(d);let f=new Jr(e,pu(100));f.position.set(0,20,0),f.scale.set(1,.1,1),this.add(f)}dispose(){let e=new Set;this.traverse(t=>{t.isMesh&&(e.add(t.geometry),e.add(t.material))});for(let t of e)t.dispose()}};function pu(e){return new ea({color:0,emissive:16777215,emissiveIntensity:e})}var mu={high:{windSegments:1e3,windPoints:14,satelliteCount:600,pixelRatioCap:2},low:{windSegments:500,windPoints:10,satelliteCount:300,pixelRatioCap:1.5}},hu={radius:2,cameraDistance:5.8,seed:1337,defaultQuality:`high`,windSegments:mu.high.windSegments,windPoints:mu.high.windPoints,satelliteCount:mu.high.satelliteCount,pixelRatioCap:mu.high.pixelRatioCap},gu=`assets/earth/blue-marble-5400x2700.jpg`,_u=`proceduralFallback`,vu=!1,yu=!1,bu=[];function xu(){return _u}function Su(){return vu}function Cu(){return yu}function wu(){return yu?`etopo1`:`none`}function Tu(){return _u===`nasaBlueMarble`?`NASA Blue Marble — NASA Earth Observatory`:`Procedural fallback (not a high-precision map)`}function Eu(e){vu?e():bu.push(e)}function Du(e){_u=e,vu=!0,bu.forEach(e=>e()),bu=[]}function Ou(e){let t=new Ii(ku());t.colorSpace=Ie,t.wrapS=n,t.anisotropy=4;let r=new $i({map:t,emissive:new X(0),emissiveIntensity:0,roughness:1,metalness:0,envMapIntensity:0,displacementScale:0,displacementBias:0}),i=new Jr(new Hi(e,320,240),r),a=new Ca;return a.load(gu,e=>{e.colorSpace=Ie,e.wrapS=n,e.anisotropy=16,e.minFilter=u,e.magFilter=c,r.map=e,r.needsUpdate=!0,t.dispose(),Du(`nasaBlueMarble`)},void 0,e=>{console.warn(`[createEarth] NASA texture load failed, using proceduralFallback:`,e),Du(`proceduralFallback`)}),a.load(`assets/earth/etopo1-heightmap-720x360.png`,e=>{e.wrapS=n,e.anisotropy=4,e.minFilter=u,r.displacementMap=e,r.displacementScale=.08,r.displacementBias=-.08,r.needsUpdate=!0,yu=!0},void 0,e=>{console.warn(`[createEarth] ETOPO1 heightmap load failed, smooth globe:`,e),yu=!1}),a.load(`assets/earth/etopo1-normalmap-720x360.png`,e=>{e.wrapS=n,e.anisotropy=4,r.normalMap=e,r.normalScale=new K(.8,.8),r.needsUpdate=!0},void 0,()=>{}),i}function ku(){let e=2048,t=1024,n=document.createElement(`canvas`);n.width=e,n.height=t;let r=n.getContext(`2d`),i=r.createLinearGradient(0,0,0,t);i.addColorStop(0,`#08263f`),i.addColorStop(.18,`#0c3a63`),i.addColorStop(.5,`#0e4377`),i.addColorStop(.82,`#0c3a63`),i.addColorStop(1,`#08263f`),r.fillStyle=i,r.fillRect(0,0,e,t),r.globalAlpha=.06,r.strokeStyle=`#2db0ff`,r.lineWidth=2;for(let n=0;n<14;n+=1){let i=t*(.2+n/14*.6)|0;r.beginPath();for(let t=0;t<=e;t+=24)r.lineTo(t,i+Math.sin(t*.01+n)*6);r.stroke()}r.globalAlpha=1;let a=t=>(t+180)/360*e,o=e=>(90-e)/180*t;function s(e,t){r.beginPath(),e.forEach(([e,t],n)=>{let i=a(e),s=o(t);n===0?r.moveTo(i,s):r.lineTo(i,s)}),r.closePath(),r.fillStyle=t,r.fill()}let c=`#3a5a26`,l=`#dfeaf2`;return s([[-168,65],[-155,70],[-130,70],[-95,72],[-75,78],[-60,75],[-55,60],[-70,48],[-80,42],[-82,30],[-95,28],[-100,25],[-110,23],[-118,32],[-125,40],[-128,49],[-135,56],[-150,60],[-168,65]],c),s([[-95,22],[-86,18],[-78,9],[-83,8],[-92,16],[-95,22]],c),s([[-80,12],[-70,12],[-58,8],[-50,0],[-35,-8],[-38,-23],[-50,-34],[-65,-42],[-70,-53],[-74,-50],[-72,-38],[-76,-25],[-80,-12],[-82,0],[-80,12]],c),s([[-10,58],[5,60],[15,62],[30,60],[40,55],[38,47],[25,46],[12,45],[0,43],[-9,44],[-10,58]],c),s([[-17,21],[-5,35],[10,36],[25,32],[34,30],[38,18],[44,12],[51,11],[42,-2],[40,-15],[35,-25],[25,-34],[18,-34],[12,-20],[9,-5],[4,5],[-8,8],[-17,14],[-17,21]],`#6a5a2a`),r.globalAlpha=.5,s([[-10,28],[10,30],[25,30],[33,28],[30,20],[10,18],[-8,20],[-10,28]],`#9a6a2a`),r.globalAlpha=1,s([[30,60],[60,70],[90,74],[120,73],[150,70],[170,66],[175,60],[160,55],[140,50],[135,42],[125,38],[122,30],[110,22],[100,14],[92,12],[80,9],[72,22],[62,25],[55,26],[48,30],[45,38],[42,44],[40,50],[35,56],[30,60]],c),s([[70,24],[78,22],[88,22],[84,10],[78,8],[72,16],[70,24]],c),s([[95,5],[105,2],[115,0],[110,-4],[100,-2],[95,5]],c),s([[120,-2],[135,-3],[140,-5],[130,-8],[118,-7],[120,-2]],c),s([[114,-22],[125,-14],[138,-12],[145,-16],[153,-26],[150,-36],[140,-38],[128,-34],[118,-32],[114,-28],[114,-22]],`#7a6a30`),s([[-50,82],[-25,82],[-18,76],[-25,65],[-45,62],[-52,70],[-50,82]],`#9fb0bb`),r.globalAlpha=.92,r.fillStyle=l,r.fillRect(0,952,e,71),r.globalAlpha=1,r.globalAlpha=.85,r.fillStyle=l,r.fillRect(0,0,e,61),r.globalAlpha=1,n}function Au(e){let t=new Cn,n=new Zi({transparent:!0,blending:2,depthWrite:!1,side:1,uniforms:{uColor:{value:new X(`#7fe6ff`)},uPower:{value:2.6},uIntensity:{value:1.15}},vertexShader:`
      varying vec3 vNormal;
      varying vec3 vView;
      void main() {
    ...
    `}),r=new Jr(new Hi(e*1.085,96,64),n);return r.renderOrder=5,t.add(r),t}function ju(e){let t=e>>>0;return function(){t|=0,t=t+1831565813|0;let e=Math.imul(t^t>>>15,1|t);return e=e+Math.imul(e^e>>>7,61|e)^e,((e^e>>>14)>>>0)/4294967296}}function Mu(e,t={}){let n=t.count??1e3,r=t.points??14,i=ju(t.seed??1337),a=[{lat:18,lon:-40,strength:1},{lat:-28,lon:95,strength:.85},{lat:42,lon:150,strength:.7}].map(t=>({...t,pos:Nu(t.lat,t.lon,e*1.024)})),o=[];for(let t=0;t<n;t+=1){let t=-70+i()*140,n=i()*360-180,s=.25+i()*.95,c=[],l=Nu(t,n,e*1.024),u=Pu(l,i),d=e*.018;for(let t=0;t<r;t+=1){let t=new q;for(let n of a){let r=n.pos.clone().sub(l),i=r.length();if(i<e*.9){let e=l.clone().normalize(),a=new q().crossVectors(e,r).normalize();t.add(a.multiplyScalar(n.strength*.06/(1+i*1.5)))}}u.add(t).normalize();let n=l.clone().normalize();u.projectOnPlane(n).normalize(),l=l.clone().add(u.clone().multiplyScalar(d)),l.setLength(e*1.024),c.push(l.clone())}o.push({points:c,speed:s,phase:i()*Math.PI*2,color:Fu(s)})}return o}function Nu(e,t,n){let r=Tt.degToRad(e),i=Tt.degToRad(t);return new q(n*Math.cos(r)*Math.cos(i),n*Math.sin(r),-n*Math.cos(r)*Math.sin(i))}function Pu(e,t){let n=e.clone().normalize(),r=Math.abs(n.y)<.9?new q(0,1,0):new q(1,0,0);return new q().crossVectors(n,r).normalize().applyAxisAngle(n,t()*Math.PI*2)}function Fu(e){let t=Math.min(1,Math.max(0,(e-.25)/.95)),n,r,i;if(t<.5){let e=t/.5;n=Iu(.43,1,e),r=Iu(.97,.9,e),i=Iu(1,.43,e)}else{let e=(t-.5)/.5;n=Iu(1,1,e),r=Iu(.9,.32,e),i=Iu(.43,.22,e)}return[n,r,i]}function Iu(e,t,n){return e+(t-e)*n}function Lu(e,t={}){let n=t.count??hu.windSegments,r=t.points??14,i=Array.isArray(t.segments)&&t.segments.length>0?t.segments:Mu(e*1.024,{count:n,points:r,seed:hu.seed}),a=[],o=[],s=[];for(let e of i){let t=e.color;for(let n=0;n<e.points.length-1;n+=1){let r=e.points[n],i=e.points[n+1],c=n/(e.points.length-1),l=(n+1)/(e.points.length-1);a.push(r.x,r.y,r.z,i.x,i.y,i.z),o.push(t[0],t[1],t[2],t[0],t[1],t[2]),s.push(c,l)}}let c=new Tr;c.setAttribute(`position`,new pr(a,3)),c.setAttribute(`color`,new pr(o,3)),c.setAttribute(`aProgress`,new pr(s,1));let l=new Zi({transparent:!0,depthWrite:!1,blending:2,uniforms:{uTime:{value:0},uFlow:{value:.55},uBase:{value:.42},uDepthFade:{value:1}},vertexShader:`
    ...
    `});return{group:new Di(c,l),count:i.length,update(e){l.uniforms.uTime.value=e},dispose(){c.dispose(),l.dispose()}}}function Ru(e,t={}){let n=t.count??hu.satelliteCount,r=ju((t.seed??hu.seed)+7777),i=new Float32Array(n*3),a=new Float32Array(n),o=new Float32Array(n),s=Math.PI*(3-Math.sqrt(5)),c=Math.PI*2;for(let t=0;t<n;t+=1){let l=1-t/Math.max(1,n-1)*2,u=Math.sqrt(Math.max(0,1-l*l)),d=s*t,f=e+e*.06+r()*e*.14;i[t*3]=Math.cos(d)*u*f,i[t*3+1]=l*f,i[t*3+2]=Math.sin(d)*u*f,a[t]=.6+r()*.8,o[t]=r()*c}return{positions:i,sizes:a,phases:o}}function zu(e,t={}){let n=t.count??hu.satelliteCount,{positions:r,sizes:i,phases:a}=Ru(e*4,{count:n,seed:hu.seed}),o=new Tr;o.setAttribute(`position`,new pr(r,3)),o.setAttribute(`aSize`,new pr(i,1)),o.setAttribute(`aPhase`,new pr(a,1));let s=new Zi({transparent:!0,depthWrite:!1,blending:2,uniforms:{uTime:{value:0},uOpacity:{value:.9},uSizeBase:{value:.075},uPixelRatio:{value:Math.min(window.devicePixelRatio,hu.pixelRatioCap)}},vertexShader:`
      uniform float uTime;
    ...
    `}),c=new Ni(o,s);return{group:c,count:n,update(e,t){c.rotation.y+=t*.02,c.rotation.x+=t*.006,s.uniforms.uTime.value=e},dispose(){o.dispose(),s.dispose()}}}var Bu={loading:`loading`,ready:`ready`,missing:`missing`};function Vu(e,t,n,r,i){if(!e)return 0;let a=(r+180)/360,o=(90-i)/180,s=Math.floor(a*t),c=Math.floor(o*n);return s=(s%t+t)%t,c<0&&(c=0),c>n-1&&(c=n-1),e[c*t+s]/255}function Hu(e,t,n,r,i){let a=[];for(let o=0;o<e.length;o+=1){let[s,c]=e[o],l=Tt.degToRad(c),u=Tt.degToRad(s),d=t+(Vu(n,r,i,s,c)*.08-.08);a.push(d*Math.cos(l)*Math.cos(u),d*Math.sin(l),-d*Math.cos(l)*Math.sin(u))}return a}function Uu(e,t,n,r,i,a,o){let s=new Cn,c=[{segs:e,color:new X(`#dffbff`),opacity:.5},{segs:t,color:new X(`#9fc6e0`),opacity:.3},{segs:n,color:new X(`#ffd27a`),opacity:.55}],l=[];for(let e of c){let t=[];for(let n of e.segs||[]){if(n.length<2)continue;let e=Hu(n,r,i,a,o);for(let n=0;n+5<e.length;n+=3)t.push(e[n],e[n+1],e[n+2],e[n+3],e[n+4],e[n+5])}if(t.length===0)continue;let n=new Tr;n.setAttribute(`position`,new pr(t,3));let c=new hi({color:e.color,transparent:!0,opacity:e.opacity,depthWrite:!1,blending:2}),u=new Di(n,c);u.renderOrder=3,s.add(u),l.push({geometry:n,material:c,count:(e.segs||[]).length})}return{group:s,status:l.length>0?Bu.ready:Bu.missing,countrySegmentCount:e?e.length:0,stateSegmentCount:t?t.length:0,chinaSegmentCount:n?n.length:0,update(){},dispose(){for(let e of l)e.geometry.dispose(),e.material.dispose()}}}async function Wu(){try{let e=await fetch(`assets/earth/etopo1-heightmap-720x360.png`,{cache:`no-cache`});if(!e.ok)return null;let t=await e.blob(),n=await createImageBitmap(t),r=document.createElement(`canvas`);r.width=n.width,r.height=n.height;let i=r.getContext(`2d`);i.drawImage(n,0,0);let{data:a}=i.getImageData(0,0,n.width,n.height),o=new Uint8Array(n.width*n.height);for(let e=0;e<o.length;e+=1)o[e]=a[e*4];return{data:o,width:n.width,height:n.height}}catch(e){return console.warn(`[boundaries] heightmap decode failed, lines will float:`,e),null}}async function Gu(e){try{let t=await fetch(`assets/boundaries/manifest.json`,{cache:`no-cache`});if(!t.ok)return Ku(`manifest HTTP `+t.status);let n=await t.json(),r=n.entries||[],i=r.find(e=>e.kind===`countries`),a=r.find(e=>e.kind===`states_provinces`),o=r.find(e=>e.kind===`china_provinces`),[s,c,l,u]=await Promise.all([i?fetch(`assets/boundaries/`+i.asset).then(e=>e.json()):Promise.resolve({segments:[]}),a?fetch(`assets/boundaries/`+a.asset).then(e=>e.json()):Promise.resolve({segments:[]}),o?fetch(`assets/boundaries/`+o.asset).then(e=>e.json()):Promise.resolve({segments:[]}),Wu()]),d=u?u.data:null,f=Uu(s.segments||[],c.segments||[],l.segments||[],e,d,u?u.width:720,u?u.height:360);return f.manifest=n,f}catch(e){return Ku(String(e))}}function Ku(e){let t=Uu([],[],[],2,null,720,360);return t.status=Bu.missing,t.missingReason=e,t}var qu={loading:`loading`,ready:`ready`,missing:`missing`};async function Ju(e){let t=document.createElement(`div`);t.className=`globe-labels`,t.style.position=`absolute`,t.style.inset=`0`,t.style.pointerEvents=`none`,t.style.zIndex=`5`;let n=[],r=qu.loading,i=null;try{let e=await fetch(`assets/labels/labels-110m.json`,{cache:`no-cache`});if(!e.ok)r=qu.missing,i=`HTTP `+e.status;else{let t=await e.json();n=Array.isArray(t.labels)?t.labels:[],r=qu.ready}}catch(e){r=qu.missing,i=String(e)}let a=n.map(e=>{let n=document.createElement(`div`);return n.className=`globe-label`+(e.capital?` globe-label--capital`:``),n.textContent=e.nameZh?`${e.name} / ${e.nameZh}`:e.name,n.dataset.bilingual=e.nameZh?`1`:`0`,n.style.display=`none`,t.appendChild(n),{el:n,label:e,pos:new q}});return{container:t,status:r,missingReason:i,labelCount:n.length,bilingualCount:n.filter(e=>e.nameZh).length,update(e,t,n,r=0){if(a.length===0)return;let i=new q(0,1,0),o=[],s=new q;e.getWorldDirection(s);for(let s of a){let{label:a,el:c,pos:l}=s,u=Tt.degToRad(a.lat),d=Tt.degToRad(a.lon),f=n;l.set(f*Math.cos(u)*Math.cos(d),f*Math.sin(u),-f*Math.cos(u)*Math.sin(d)),r!==0&&l.applyAxisAngle(i,r);let p=l.clone().normalize(),m=e.position.clone().sub(l).normalize();if(p.dot(m)<.1){c.style.display=`none`;continue}let h=l.clone().project(e),g=(h.x*.5+.5)*t.width,_=(-h.y*.5+.5)*t.height;if(g<0||_<0||g>t.width||_>t.height){c.style.display=`none`;continue}let v=c._w,y=c._h;if(v==null){c.style.display=`block`;let e=c.getBoundingClientRect();v=c._w=e.width||40,y=c._h=e.height||12}let b={x:g-v/2,y:_-y/2,w:v,h:y},x=!1;for(let e of o)if(!(b.x+b.w<=e.x||e.x+e.w<=b.x||b.y+b.h<=e.y||e.y+e.h<=b.y)){x=!0;break}if(x){c.style.display=`none`;continue}c.style.display=`block`,c.style.left=`${g-v/2}px`,c.style.top=`${_-y/2}px`,c.style.opacity=String(Tt.clamp(p.dot(m)*1.4,.2,1)),o.push(b)}},dispose(){for(let e of a)e.el.remove();t.parentNode&&t.parentNode.removeChild(t)}}}var Yu=[`schemaVersion`,`source`,`producer`,`access`,`variables`,`units`,`timeUtc`,`grid`,`u`,`v`,`speedStats`,`preprocess`,`licenseNotice`];function Xu(e){let t=[];if(!e||typeof e!=`object`)return{ok:!1,errors:[`frame is not an object`],stats:null};for(let n of Yu)n in e||t.push(`missing field: ${n}`);e.schemaVersion&&e.schemaVersion!==`era5-wind-frame-v1`&&t.push(`unexpected schemaVersion: ${e.schemaVersion}`);let n=String(e.source??``).toLowerCase();n&&!n.includes(`era5`)&&t.push(`source does not declare ERA5: ${e.source}`),e.producer&&!/copernicus|ecmwf/i.test(String(e.producer))&&t.push(`producer must reference Copernicus/ECMWF: ${e.producer}`);let r=e.grid,i=0,a=0;r&&typeof r==`object`&&(i=Number(r.width)||0,a=Number(r.height)||0,(!Array.isArray(r.lon)||r.lon.length!==2)&&t.push(`grid.lon must be [min,max]`),(!Array.isArray(r.lat)||r.lat.length!==2)&&t.push(`grid.lat must be [min,max]`));let o=e.u,s=e.v;!Array.isArray(o)||!Array.isArray(s)?t.push(`u and v must be arrays`):o.length===s.length?i&&a&&o.length!==i*a&&t.push(`u length ${o.length} != width*height ${i*a}`):t.push(`u/v length mismatch: ${o.length} vs ${s.length}`);let c=null;if(Array.isArray(o)&&Array.isArray(s)&&o.length===s.length&&o.length>0){let e=1/0,n=-1/0,r=0,i=0;for(let t=0;t<o.length;t+=1){let a=o[t],c=s[t];if(!Number.isFinite(a)||!Number.isFinite(c)){i+=1;continue}let l=Math.hypot(a,c);l<e&&(e=l),l>n&&(n=l),r+=l}let a=o.length-i;a<=0?t.push(`no finite wind values`):c={min:e,max:n,mean:r/a,nonFinite:i,count:a}}if(e.speedStats){let n=e.speedStats;for(let e of[`min`,`max`,`mean`,`p95`])n[e]!==void 0&&!Number.isFinite(n[e])&&t.push(`speedStats.${e} not finite`);Number.isFinite(n.min)&&Number.isFinite(n.max)&&Number.isFinite(n.mean)&&!(n.min<=n.mean&&n.mean<=n.max)&&t.push(`speedStats not ordered: min <= mean <= max violated`),Number.isFinite(n.p95)&&Number.isFinite(n.mean)&&n.p95<n.mean&&t.push(`speedStats p95 < mean`)}return{ok:t.length===0,errors:t,stats:c}}var Zu=`data/era5/manifest.json`;function Qu(e,t){return new URL(e,t).href}async function $u(){let e,t=new URL(Zu,window.location.href).href;try{let n=await fetch(t,{cache:`no-cache`});if(!n.ok)return{status:`missing`,reason:`manifest fetch failed: HTTP ${n.status}`};e=await n.json()}catch(e){return{status:`missing`,reason:`manifest fetch error: ${String(e)}`}}return!e||!e.frame?{status:`missing`,reason:`manifest has no frame path`}:ed(e.frame,t)}async function ed(e,t){let n=Qu(e,t),r;try{let e=await fetch(n,{cache:`no-cache`});if(!e.ok)return{status:`missing`,reason:`frame fetch failed: HTTP ${e.status}`};r=await e.json()}catch(e){return{status:`missing`,reason:`frame fetch error: ${String(e)}`}}let{ok:i,errors:a,stats:o}=Xu(r);return i?{status:`era5`,frame:r,stats:o}:{status:`missing`,reason:`frame invalid: ${a.join(`; `)}`}}async function td(){let e=new URL(Zu,window.location.href).href,t;try{let n=await fetch(e,{cache:`no-cache`});if(!n.ok)return{status:`missing`,reason:`manifest fetch failed: HTTP ${n.status}`};t=await n.json()}catch(e){return{status:`missing`,reason:`manifest fetch error: ${String(e)}`}}let n=Array.isArray(t.frames)&&t.frames.length>0?t.frames.map(e=>e.file):t.frame?[t.frame]:[];if(n.length===0)return{status:`missing`,reason:`manifest has no frames`};let r=[];for(let t of n){let n=await ed(t,e);n.status===`era5`&&r.push({frame:n.frame,stats:n.stats,timeUtc:n.frame.timeUtc})}return r.length===0?{status:`missing`,reason:`no valid frames loaded`}:{status:`era5`,frames:r,count:r.length}}function nd(e,t,n={}){if(!e||!Array.isArray(e.u)||!Array.isArray(e.v))return[];let r=e.grid;if(!r||!r.lon||!r.lat)return[];let i=Number(r.width)||0,a=Number(r.height)||0;if(i<=0||a<=0||e.u.length!==i*a)return[];let o=r.lon[0],s=r.lon[1],c=r.lat[0],l=r.lat[1],u=s-o,d=l-c,f=n.count??1e3,p=n.points??14,m=ju((n.seed??1337)+31),h=e.speedStats||{},g=Number.isFinite(h.p5)?h.p5:1.5,_=Number.isFinite(h.p95)?h.p95:12,v=t*1.024,y=[];for(let t=0;t<f;t+=1){let t=c+m()*d,n=o+m()*u,r=[],f=0;for(let u=0;u<p;u+=1){let{u,v:d}=rd(e.u,e.v,i,a,t,n,o,s,c,l),p=Math.hypot(u,d);if(!Number.isFinite(p))break;p>f&&(f=p);let m=.9/Math.max(.6,p);n+=u*m,t+=d*m,n=ad(n,o,s),t>l&&(t=l),t<c&&(t=c),r.push(id(t,n,v))}r.length<2||y.push({points:r,speed:f,color:sd(f,g,_),phase:m()*Math.PI*2})}return y}function rd(e,t,n,r,i,a,o,s,c,l){let u=(a-o)/(s-o)*(n-1),d=c,f=l,p=(f-i)/(f-d)*(r-1),m=Math.floor(od(u,0,n-1)),h=Math.floor(od(p,0,r-1)),g=Math.min(n-1,m+1),_=Math.min(r-1,h+1),v=od(u-m,0,1),y=od(p-h,0,1),b=h*n+m,x=h*n+g,S=_*n+m,C=_*n+g,w=e[b]??0,T=e[x]??0,E=e[S]??0,D=e[C]??0,O=t[b]??0,k=t[x]??0,A=t[S]??0,j=t[C]??0,ee=(1-v)*(1-y),M=v*(1-y),te=(1-v)*y,N=v*y;return{u:ee*w+M*T+te*E+N*D,v:ee*O+M*k+te*A+N*j}}function id(e,t,n){let r=Tt.degToRad(e),i=Tt.degToRad(t);return new q(n*Math.cos(r)*Math.cos(i),n*Math.sin(r),-n*Math.cos(r)*Math.sin(i))}function ad(e,t,n){let r=n-t,i=e;for(;i<t;)i+=r;for(;i>n;)i-=r;return i}function od(e,t,n){return e<t?t:e>n?n:e}function sd(e,t,n){let r=od((e-t)/Math.max(.001,n-t),0,1),i=[[0,[.43,.97,1]],[.35,[.92,.97,1]],[.7,[1,.82,.32]],[1,[1,.32,.22]]],a=i[0],o=i[i.length-1];for(let e=0;e<i.length-1;e+=1)if(r>=i[e][0]&&r<=i[e+1][0]){a=i[e],o=i[e+1];break}let s=(r-a[0])/Math.max(1e-4,o[0]-a[0]);return[a[1][0]+(o[1][0]-a[1][0])*s,a[1][1]+(o[1][1]-a[1][1])*s,a[1][2]+(o[1][2]-a[1][2])*s]}var cd=`loading`,ld=null,ud=null;function dd(e){cd=`era5`,ld=e,ud=null}function fd(){cd=`devSynthetic`}function pd(e){cd=`missing`,ud=e??`no wind data`}function md(){cd=`loading`}function hd(){return{status:cd,isEra5:cd===`era5`,frame:ld,reason:ud}}var gd=Math.PI*.5;function _d(e,t,n){let r=Tt.degToRad(t),i=Tt.degToRad(e);return new q(n*Math.cos(r)*Math.cos(i),n*Math.sin(r),-n*Math.cos(r)*Math.sin(i))}var vd=new class{constructor(e){this.canvas=e,this.scene=new jn,this.camera=new La(42,1,.1,100),this.renderer=null,this.composer=null,this.controls=null,this.root=new Cn,this.clock=new co,this.resizeObserver=null,this.layers=[],this.quality=hu.defaultQuality,this.paused=!1,this.postprocessingEnabled=!1,this.currentWindCount=0,this.currentSatelliteCount=0,this.frozenElapsed=0,this.frozenDelta=0,this.era5Frame=null,this.era5Stats=null,this.windLayerKind=`devSynthetic`,this.era5Series=[],this.frameIndex=0,this.windPlaying=!0,this.frameAccum=0,this.frameInterval=6}init(){this.renderer=new kl({canvas:this.canvas,antialias:!0,alpha:!0});let e=new URLSearchParams(window.location.search).get(`lowres`)===`1`;this.testScale=e?.5:1,this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,hu.pixelRatioCap)*this.testScale),this.renderer.outputColorSpace=Ie,this.renderer.toneMapping=4,this.renderer.toneMappingExposure=1.08;let t=new Io(this.renderer);if(this.scene.environment=t.fromScene(new fu,.04).texture,this.scene.environmentIntensity=.15,this.scene.background=null,this.camera.position.set(.8,1.2,hu.cameraDistance),this.controls=new zl(this.camera,this.canvas),this.controls.enableDamping=!0,this.controls.dampingFactor=.06,this.controls.enablePan=!1,this.controls.minDistance=2.18,this.controls.maxDistance=12,this.controls.zoomSpeed=.8,this.sunLight=new Ha(`#fff6e8`,2.6),this.scene.add(this.sunLight,this.sunLight.target),this.nightFill=new Ta(`#aebfe0`,`#070b14`,1.9),this.scene.add(this.nightFill,this.root),this.nightAmbient=new Ua(`#7d8aa6`,.8),this.scene.add(this.nightAmbient),this.nightFillEnabled=!0,this.updateSunFromTime(this.era5Frame?.timeUtc??null),this.root.rotation.y=gd,this.buildLayers(),new URLSearchParams(window.location.search).get(`nobloom`)===`1`)this.postprocessingEnabled=!1,this.composer=null;else try{this.composer=new ou(this.renderer),this.composer.addPass(new su(this.scene,this.camera)),this.composer.addPass(new lu(new K(1,1),.3,.55,.4)),this.composer.addPass(new du),this.postprocessingEnabled=!0}catch(e){this.postprocessingEnabled=!1,this.composer=null,console.warn(`[EarthScene] postprocessing unavailable, falling back to direct render`,e)}this.resizeObserver=new ResizeObserver(()=>this.resize()),this.resizeObserver.observe(this.canvas.parentElement),this.resize(),this.animate(),this.attachTestHook(),Eu(()=>this.updateEarthMapBadge()),this.boundariesStatus=`loading`,this.loadBoundaries(),this.labelsStatus=`loading`,this.loadLabels(),md(),this.loadEra5()}async loadLabels(){try{let e=await Ju(hu.radius);this.labelsLayer=e,this.labelsStatus=e.status,this.canvas&&this.canvas.parentElement&&this.canvas.parentElement.appendChild(e.container),this.labelsInfo={labelCount:e.labelCount,bilingualCount:e.bilingualCount,source:`naturalEarth110m`}}catch(e){this.labelsStatus=`missing`,console.warn(`[EarthScene] labels load failed:`,e)}}async loadBoundaries(){try{let e=await Gu(hu.radius);this.boundariesLayer=e,this.root.add(e.group),this.boundariesStatus=e.status,this.boundariesLayerInfo={countrySegmentCount:e.countrySegmentCount,stateSegmentCount:e.stateSegmentCount,chinaSegmentCount:e.chinaSegmentCount??0,source:`naturalEarth110m+10m`}}catch(e){this.boundariesStatus=`missing`,console.warn(`[EarthScene] boundaries load failed:`,e)}}async loadEra5(){try{let e=await td();if(e.status===`era5`&&e.frames.length>0){this.era5Series=e.frames,this.frameIndex=0;let t=e.frames[0];this.era5Frame=t.frame,this.era5Stats=t.stats,this.rebuildWindLayerAsEra5()}else{let e=await $u();e.status===`era5`?(this.era5Series=[{frame:e.frame,stats:e.stats,timeUtc:e.frame.timeUtc}],this.frameIndex=0,this.era5Frame=e.frame,this.era5Stats=e.stats,this.rebuildWindLayerAsEra5()):(fd(),this.windLayerKind=`devSynthetic`,this.updateWindSourceBadge(),console.warn(`[EarthScene] ERA5 frame unavailable, using devSynthetic wind:`,e.reason))}}catch(e){pd(String(e)),this.updateWindSourceBadge(),console.warn(`[EarthScene] ERA5 load error:`,e)}}stepWindFrame(e=1){if(this.era5Series.length<2)return this.frameIndex;let t=(this.frameIndex+e+this.era5Series.length)%this.era5Series.length;this.frameIndex=t;let n=this.era5Series[t];return this.era5Frame=n.frame,this.era5Stats=n.stats,this.currentFrameTimeUtc=n.timeUtc,this.rebuildWindLayerAsEra5(),t}setWindPlaying(e){this.windPlaying=!!e}rebuildWindLayerAsEra5(){if(!this.era5Frame)return;let e=mu[this.quality]??mu[hu.defaultQuality],t=nd(this.era5Frame,hu.radius,{count:e.windSegments,points:e.windPoints,seed:hu.seed});if(!t||t.length===0){fd(`traceWindStreamlines returned no segments`),this.updateWindSourceBadge();return}this.windLayer&&(this.windLayer.dispose?.(),this.root.remove(this.windLayer.group)),this.windLayer=Lu(hu.radius,{count:e.windSegments,points:e.windPoints,segments:t}),this.root.add(this.windLayer.group),this.layers=[this.windLayer,this.satelliteLayer],this.currentWindCount=this.windLayer.count??t.length,this.windLayerKind=`era5`,this.currentFrameTimeUtc=this.era5Frame.timeUtc,dd(this.era5Frame),this.updateWindSourceBadge()}updateWindSourceBadge(){let e=typeof document<`u`?document.querySelector(`#wind-source`):null;if(!e)return;let{status:t,isEra5:n}=hd();e.textContent=n?`ERA5 风场`:t===`missing`?`ERA5 数据缺失`:`合成风场（dev）`,e.dataset.source=t}buildLayers(){this.earthMesh=Ou(hu.radius),this.atmosphereMesh=Au(hu.radius),this.root.add(this.earthMesh,this.atmosphereMesh),this.buildDynamicLayers()}buildDynamicLayers(){let e=mu[this.quality]??mu[hu.defaultQuality];this.currentPreset=e;let t=Lu(hu.radius,{count:e.windSegments,points:e.windPoints}),n=zu(hu.radius,{count:e.satelliteCount});this.windLayer=t,this.satelliteLayer=n,this.root.add(t.group,n.group),this.layers=[t,n],this.currentWindCount=t.count??0,this.currentSatelliteCount=n.count??0,this.renderer&&this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,e.pixelRatioCap))}disposeDynamicLayers(){for(let e of this.layers)e.dispose?.(),e.group&&this.root.remove(e.group);this.layers=[],this.windLayer=null,this.satelliteLayer=null}resize(){let e=this.canvas.parentElement.getBoundingClientRect(),t=Math.max(320,Math.floor(e.width)),n=Math.max(320,Math.floor(e.height)),r=Math.floor(t*this.testScale),i=Math.floor(n*this.testScale);this.camera.aspect=r/i,this.camera.updateProjectionMatrix(),this.renderer.setSize(r,i,!1),this.canvas.style.width=`${t}px`,this.canvas.style.height=`${n}px`,this.composer&&this.composer.setSize(r,i)}animate(){if(requestAnimationFrame(()=>this.animate()),this.renderFrozen)return;let e=this.clock.getElapsedTime(),t=this.clock.getDelta(),n=this.paused?this.frozenElapsed:e,r=this.paused?0:t;this.paused||(this.frozenElapsed=e),this.root.rotation.y+=r*.08,this.era5Series.length>1&&this.windPlaying&&!this.paused&&!this.renderFrozen&&(this.frameAccum+=r,this.frameAccum>=this.frameInterval&&(this.frameAccum=0,this.stepWindFrame(1)));let i=this.currentFrameTimeUtc??this.era5Frame?.timeUtc??null;i!==this._lastSunTime&&(this._lastSunTime=i,this.updateSunFromTime(i));for(let e of this.layers)e.update?.(n,r);if(this.controls.update(),this.labelsLayer){let e=this.canvas.getBoundingClientRect();this.labelsLayer.update(this.camera,e,hu.radius,this.root.rotation.y)}this.composer?this.composer.render():this.renderer.render(this.scene,this.camera)}setPaused(e){this.paused=!!e}setRenderFreeze(e){this.renderFrozen=!!e,this.renderFrozen&&(this.composer?this.composer.render():this.renderer.render(this.scene,this.camera))}setQuality(e){mu[e]&&e!==this.quality&&(this.quality=e,this.disposeDynamicLayers(),this.buildDynamicLayers())}resetCamera(){this.camera.position.set(.8,1.2,hu.cameraDistance),this.controls.target.set(0,0,0),this.controls.update(),this.root.rotation.y=gd}updateSunFromTime(e){let t=12;if(typeof e==`string`){let n=/T(\d{2}):(\d{2})/.exec(e);n&&(t=Number(n[1])+Number(n[2])/60)}let n=_d(-15*(t-12),18,1),r=this.camera.position.length()+10;this.sunLight.position.copy(n.clone().multiplyScalar(r)),this.sunLight.target.position.set(0,0,0),this.sunLight.target.updateMatrixWorld(),this.currentSunDirection=[n.x,n.y,n.z]}updateEarthMapBadge(){let e=typeof document<`u`?document.querySelector(`#earth-map-source`):null;if(!e)return;let t=xu();e.textContent=t===`nasaBlueMarble`?`NASA Blue Marble`:`程序化纹理（fallback）`,e.dataset.source=t}attachTestHook(){typeof window>`u`||(window.__viz={ready:!0,paused:()=>this.paused,quality:()=>this.quality,drawCalls:()=>this.renderer.info.render.calls,satelliteCount:()=>this.currentSatelliteCount,windCount:()=>this.currentWindCount,cameraDistance:()=>this.camera.position.length(),postprocessing:()=>this.postprocessingEnabled,windSource:()=>hd().status,windLayerKind:()=>this.windLayerKind,windFrameTime:()=>this.era5Frame?.timeUtc??null,windFrameStats:()=>this.era5Stats??null,era5Ready:()=>hd().isEra5,windFrameCount:()=>this.era5Series.length,windFrameIndex:()=>this.frameIndex,windPlaying:()=>this.windPlaying,stepWindFrame:e=>this.stepWindFrame(e),setWindPlaying:e=>this.setWindPlaying(e),earthMapReady:()=>Su(),lightingMode:()=>`realisticSun`,nightFillEnabled:()=>this.nightFillEnabled,sunDirection:()=>this.currentSunDirection??[1,0,0],setRenderFreeze:e=>this.setRenderFreeze(e),earthMapSource:()=>xu(),earthMapAttribution:()=>Tu(),terrainReady:()=>Cu(),terrainSource:()=>wu(),terrainDisplacementScale:()=>.08,boundariesStatus:()=>this.boundariesStatus,boundariesInfo:()=>this.boundariesLayerInfo??null,labelsStatus:()=>this.labelsStatus,labelsInfo:()=>this.labelsInfo??null,visibleLabelCount:()=>document?document.querySelectorAll(`.globe-label:not([style*='display: none'])`).length:0,setPaused:e=>this.setPaused(e),setQuality:e=>this.setQuality(e),resetCamera:()=>this.resetCamera()})}}(document.querySelector(`#globe-canvas`));vd.init();var yd=document.querySelector(`#btn-pause`),bd=document.querySelector(`#btn-reset`),xd=document.querySelector(`#select-quality`);function Sd(){let e=vd.paused;yd.textContent=e?`播放`:`暂停`,yd.setAttribute(`aria-pressed`,String(e))}yd.addEventListener(`click`,()=>{vd.setPaused(!vd.paused),Sd()}),bd.addEventListener(`click`,()=>{vd.resetCamera()});var Cd=document.querySelector(`#btn-wind-step`),wd=document.querySelector(`#btn-wind-play`);function Td(){let e=vd.windPlaying;wd.textContent=e?`风场自动播放`:`风场已暂停`,wd.setAttribute(`aria-pressed`,String(e))}Cd.addEventListener(`click`,()=>{vd.stepWindFrame(1)}),wd.addEventListener(`click`,()=>{vd.setWindPlaying(!vd.windPlaying),Td()}),Td(),xd.addEventListener(`change`,()=>{vd.setQuality(xd.value),vd.updateWindSourceBadge?.()});function Ed(e){document.body.classList.toggle(`demo-mode`,e)}var Dd=!1;window.addEventListener(`keydown`,e=>{e.key===`h`&&(Dd=!Dd,Ed(Dd))}),window.__viz=window.__viz||{},window.__viz.setDemoMode=Ed,window.__viz.demoMode=()=>document.body.classList.contains(`demo-mode`),Sd();